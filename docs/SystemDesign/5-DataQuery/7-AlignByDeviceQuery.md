...
4. Determine whether the current subquery type is GroupByQuery, AggregationQuery, FillQuery or RawDataQuery. Perform the corresponding query and return the result set. The implementation logic [Raw data query](../5-DataQuery/3-RawDataQuery.html)，[Aggregate query](../5-DataQuery/4-AggregationQuery.html)，[Downsampling query](../5-DataQuery/5-GroupByQuery.html)  can be referenced.
