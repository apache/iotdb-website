...
or
IoTDB&gt; exit
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,36),y=s(`<h3 id="stop-iotdb" tabindex="-1"><a class="header-anchor" href="#stop-iotdb" aria-hidden="true">#</a> Stop IoTDB</h3><p>The server can be stopped with ctrl-C or the following script:</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code># Unix/OS X
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div>`,8),B=s('<h2 id="basic-configuration" tabindex="-1"><a class="header-anchor" href="#basic-configuration" aria-hidden="true">#</a> Basic configuration</h2><p>The configuration files is in the <code>conf</code> folder, includes:</p><ul><li>environment configuration (<code>datanode-env.bat</code>, <code>datanode-env.sh</code>),</li><li>system configuration (<code>iotdb-datanode.properties</code>)</li><li>log configuration (<code>logback.xml</code>).</li></ul>',3);function A(N,O){const n=d("RouterLink"),o=d("ExternalLinkIcon");return l(),c("div",null,[u(`
...
`),m,e("p",null,[i("This short guide will walk you through the basic process of using IoTDB. For a more-complete guide, please visit our website's "),t(n,{to:"/UserGuide/V1.2.x/IoTDB-Introduction/What-is-IoTDB.html"},{default:a(()=>[i("User Guide")]),_:1}),i(".")]),v,b,p,g,f,e("ul",null,[_,T,e("li",null,[i("Using Docker：The path to the dockerfile is "),e("a",x,[i("github"),t(o)])])]),w,e("p",null,[i("You can download the binary file from:"),I,e("a",S,[i("Download Page"),t(o)])]),E,e("p",null,[i("For more, see "),t(n,{to:"/UserGuide/V1.2.x/Reference/DataNode-Config-Manual.html"},{default:a(()=>[i("Config")]),_:1}),i(" in detail.")]),D,e("p",null,[i("For more on what commands are supported by IoTDB SQL, see "),t(n,{to:"/UserGuide/V1.2.x/SQL-Manual/SQL-Manual.html"},{default:a(()=>[i("SQL Reference")]),_:1}),i(".")]),y,e("p",null,[i("More about administration management："),t(n,{to:"/UserGuide/V1.2.x/User-Manual/Security-Management.html"},{default:a(()=>[i("Administration Management")]),_:1})]),B])}const L=r(h,[["render",A],["__file","QuickStart.html.vue"]]);export{L as default};
