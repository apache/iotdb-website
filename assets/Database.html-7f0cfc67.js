import{_ as i,M as d,N as r,af as o,O as l,Q as e,ag as t,ac as n,aT as s,C as c}from"./framework-ae7271bd.js";const u={},h=s(`<h1 id="database-management" tabindex="-1"><a class="header-anchor" href="#database-management" aria-hidden="true">#</a> Database Management</h1><h2 id="create-database" tabindex="-1"><a class="header-anchor" href="#create-database" aria-hidden="true">#</a> Create Database</h2><p>According to the storage model we can set up the corresponding database. Two SQL statements are supported for creating databases, as follows:</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>IoTDB &gt; create database root.ln
...
`),h,l("p",null,[e("After creating the database, we can use the "),t(a,{to:"/UserGuide/Master/Reference/SQL-Reference.html"},{default:n(()=>[e("SHOW DATABASES")]),_:1}),e(" statement and "),t(a,{to:"/UserGuide/Master/Reference/SQL-Reference.html"},{default:n(()=>[e("SHOW DATABASES <PathPattern>")]),_:1}),e(" to view the databases. The SQL statements are as follows:")]),b])}const T=i(u,[["render",m],["__file","Database.html.vue"]]);export{T as default};
