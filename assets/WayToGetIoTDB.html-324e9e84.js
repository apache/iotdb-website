import{_ as o,r as i,o as p,c,a as l,d as n,e as s,b as e,f as t}from"./app-239fe767.js";const r={},d=n("h1",{id:"下载与安装",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#下载与安装","aria-hidden":"true"},"#"),s(" 下载与安装")],-1),u=n("p",null,"IoTDB 为您提供了两种安装方式，您可以参考下面的建议，任选其中一种：",-1),v=n("p",null,"第一种，从官网下载安装包。这是我们推荐使用的安装方式，通过该方式，您将得到一个可以立即使用的、打包好的二进制可执行文件。",-1),k=n("p",null,"第二种，使用源码编译。若您需要自行修改代码，可以使用该安装方式。",-1),b=n("h2",{id:"安装环境要求",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#安装环境要求","aria-hidden":"true"},"#"),s(" 安装环境要求")],-1),m=n("p",null,"安装前请保证您的电脑上配有 JDK>=1.8 的运行环境，并配置好 JAVA_HOME 环境变量。",-1),_=n("p",null,"如果您需要从源码进行编译，还需要安装：",-1),h={href:"https://maven.apache.org/install.html",target:"_blank",rel:"noopener noreferrer"},g=n("blockquote",null,[n("p",null,"注： 也可以选择不安装，使用我们提供的'mvnw' 或 'mvnw.cmd' 工具。使用时请用'mvnw' 或 'mvnw.cmd'命令代替下文的'mvn'命令。")],-1),f=n("h2",{id:"从官网下载二进制可执行文件",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#从官网下载二进制可执行文件","aria-hidden":"true"},"#"),s(" 从官网下载二进制可执行文件")],-1),y={href:"http://iotdb.apache.org/Download/",target:"_blank",rel:"noopener noreferrer"},x=t(`<p>下载后，您可使用以下操作对 IoTDB 的压缩包进行解压：</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>Shell &gt; unzip iotdb-&lt;version&gt;.zip
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p>切换分支之后就可以使用以下命令进行编译：</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>&gt; mvn clean package -pl iotdb-core/datanode -am -Dmaven.test.skip=true
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p>编译完成后就可以在<code>{module.name}/target</code>目录中找到需要的包了。</p><h2 id="通过-docker-安装" tabindex="-1"><a class="header-anchor" href="#通过-docker-安装" aria-hidden="true">#</a> 通过 Docker 安装</h2>`,10),T={href:"https://hub.docker.com/r/apache/iotdb",target:"_blank",rel:"noopener noreferrer"},S=n("br",null,null,-1),q=t(`<h3 id="简单尝试" tabindex="-1"><a class="header-anchor" href="#简单尝试" aria-hidden="true">#</a> 简单尝试</h3><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token comment"># 获取镜像</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="集群部署" tabindex="-1"><a class="header-anchor" href="#集群部署" aria-hidden="true">#</a> 集群部署</h3>`,6),B={href:"https://github.com/apache/iotdb/tree/master/docker/src/main/DockerCompose/docker-compose-cluster-1c2d.yml",target:"_blank",rel:"noopener noreferrer"},A=t(`<p>假如有三台物理机，它们的hostname分别是iotdb-1、iotdb-2、iotdb-3。依次启动。<br> 以 iotdb-2 节点的docker-compose文件为例：</p><div class="language-yaml line-numbers-mode" data-ext="yml"><pre class="language-yaml"><code><span class="token key atrule">version</span><span class="token punctuation">:</span> <span class="token string">&quot;3&quot;</span>
<span class="token key atrule">services</span><span class="token punctuation">:</span>
...
`),d,u,v,k,b,m,_,n("ol",null,[n("li",null,[s("Maven >= 3.6 的运行环境，具体安装方法可以参考以下链接："),n("a",h,[s("https://maven.apache.org/install.html"),e(a)]),s("。")])]),g,f,n("p",null,[s("您可以从 "),n("a",y,[s("http://iotdb.apache.org/Download/"),e(a)]),s(" 上下载已经编译好的可执行程序 iotdb-xxx.zip，该压缩包包含了 IoTDB 系统运行所需的所有必要组件。")]),x,n("p",null,[s("您可以获取已发布的源码 "),n("a",I,[s("https://iotdb.apache.org/Download/"),e(a)]),s(" ，或者从 "),n("a",w,[s("https://github.com/apache/iotdb/tree/master"),e(a)]),s(" git 仓库获取")]),D,n("p",null,[s("Apache IoTDB 的 Docker 镜像已经上传至 "),n("a",T,[s("https://hub.docker.com/r/apache/iotdb"),e(a)]),s("。"),S,s(" Apache IoTDB 的配置项以环境变量形式添加到容器内。")]),q,n("p",null,[s("目前只支持 host 网络和 overlay 网络，不支持 bridge 网络。overlay 网络参照"),n("a",B,[s("1C2D"),e(a)]),s("的写法，host 网络如下。")]),A])}const E=o(r,[["render",C],["__file","WayToGetIoTDB.html.vue"]]);export{E as default};
