import{_ as t,r as d,o as v,c,a as u,d as e,e as n,b as s,w as l,f as i}from"./app-TbPccx1r.js";const o={},p=i('<h2 id="数据画像" tabindex="-1"><a class="header-anchor" href="#数据画像" aria-hidden="true">#</a> 数据画像</h2><h3 id="acf" tabindex="-1"><a class="header-anchor" href="#acf" aria-hidden="true">#</a> ACF</h3><h4 id="函数简介" tabindex="-1"><a class="header-anchor" href="#函数简介" aria-hidden="true">#</a> 函数简介</h4>',3),m=e("p",null,[e("strong",null,"函数名："),n(" ACF")],-1),b=e("p",null,[e("strong",null,"输入序列："),n(" 仅支持单个输入序列，类型为 INT32 / INT64 / FLOAT / DOUBLE。")],-1),T=e("strong",null,"输出序列：",-1),h=i(`<p><strong>提示：</strong></p><ul><li>序列中的<code>NaN</code>值会被忽略，在计算中表现为0。</li></ul><h4 id="使用示例" tabindex="-1"><a class="header-anchor" href="#使用示例" aria-hidden="true">#</a> 使用示例</h4><p>输入序列：</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>+-----------------------------+---------------+
