...
`),h,o("p",null,[e("游程编码也可用于对浮点数进行编码，但在创建时间序列的时候需指定保留小数位数（MAX_POINT_NUMBER，具体指定方式参见本文 "),d(n,{to:"/zh/UserGuide/V0.13.x/Reference/SQL-Reference.html"},{default:c(()=>[e("SQL 参考文档")]),_:1}),e("）。比较适合存储某些浮点数值连续出现的序列数据，不适合存储对小数点后精度要求较高以及前后波动较大的序列数据。")]),I])}const N=i(L,[["render",p],["__file","Encoding.html.vue"]]);export{N as default};
