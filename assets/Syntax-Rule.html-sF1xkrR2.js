...
`),v,n("p",null,[e("时间戳是一个数据到来的时间点，在 IoTDB 中分为绝对时间戳和相对时间戳。详细信息可参考 "),a(t,{to:"/zh/UserGuide/Master/Basic-Concept/Data-Type.html"},{default:p(()=>[e("数据类型文档")]),_:1}),e("。")]),m,n("p",null,[e("关于 IoTDB 的关键字列表，可以查看 "),n("a",k,[e("关键字"),a(l)]),e(" 。")]),h,b,g,w])}const L=d(u,[["render",E],["__file","Syntax-Rule.html.vue"]]);export{L as default};
