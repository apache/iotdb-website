...
`),m,e("p",null,[i("The specified syntax for compression is detailed in "),c(t,{to:"/UserGuide/V1.2.x/Reference/SQL-Reference.html"},{default:l(()=>[i("Create Timeseries Statement")]),_:1}),i(".")]),p,u,f,_])}const w=s(h,[["render",g],["__file","Compression.html.vue"]]);export{w as default};