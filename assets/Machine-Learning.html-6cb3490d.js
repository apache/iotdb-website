...
+-----------------------------+---------------------------+
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="representation" tabindex="-1"><a class="header-anchor" href="#representation" aria-hidden="true">#</a> Representation</h3><h4 id="函数简介-1" tabindex="-1"><a class="header-anchor" href="#函数简介-1" aria-hidden="true">#</a> 函数简介</h4><p>本函数用于时间序列的表示。</p><p><strong>函数名:</strong> Representation</p><p><strong>输入序列:</strong> 仅支持单个输入序列，类型为 INT32 / INT64 / FLOAT / DOUBLE。</p><p><strong>参数:</strong></p><ul><li><code>tb</code>：时间分块数量。默认为10。</li><li><code>vb</code>：值分块数量。默认为10。</li></ul><p><strong>输出序列:</strong> 输出单个序列，类型为INT32，长度为<code>tb*vb</code>。序列的时间戳从0开始，仅用于表示顺序。</p><p><strong>提示:</strong></p><ul><li><code>tb </code>,<code>vb</code>应为正整数。</li></ul><h4 id="使用示例-1" tabindex="-1"><a class="header-anchor" href="#使用示例-1" aria-hidden="true">#</a> 使用示例</h4><h5 id="指定时间分块数量、值分块数量" tabindex="-1"><a class="header-anchor" href="#指定时间分块数量、值分块数量" aria-hidden="true">#</a> 指定时间分块数量、值分块数量</h5><p>输入序列：</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>+-----------------------------+---------------+
|                         Time|root.test.d0.s0|
+-----------------------------+---------------+
|2020-01-01T00:00:01.000+08:00|           -4.0|
|2020-01-01T00:00:02.000+08:00|           -3.0|
...
+-----------------------------+-------------------------------------------------+
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="rm" tabindex="-1"><a class="header-anchor" href="#rm" aria-hidden="true">#</a> RM</h3><h4 id="函数简介-2" tabindex="-1"><a class="header-anchor" href="#函数简介-2" aria-hidden="true">#</a> 函数简介</h4><p>本函数用于基于时间序列表示的匹配度。</p><p><strong>函数名:</strong> RM</p><p><strong>输入序列:</strong> 仅支持两个输入序列，类型为 INT32 / INT64 / FLOAT / DOUBLE。</p><p><strong>参数:</strong></p><ul><li><code>tb</code>：时间分块数量。默认为10。</li><li><code>vb</code>：值分块数量。默认为10。</li></ul><p><strong>输出序列:</strong> 输出单个序列，类型为DOUBLE，长度为<code>1</code>。序列的时间戳从0开始，序列仅有一个数据点，其时间戳为0，值为两个时间序列的匹配度。</p><p><strong>提示:</strong></p><ul><li><code>tb </code>,<code>vb</code>应为正整数。</li></ul><h4 id="使用示例-2" tabindex="-1"><a class="header-anchor" href="#使用示例-2" aria-hidden="true">#</a> 使用示例</h4><h5 id="指定时间分块数量、值分块数量-1" tabindex="-1"><a class="header-anchor" href="#指定时间分块数量、值分块数量-1" aria-hidden="true">#</a> 指定时间分块数量、值分块数量</h5><p>输入序列：</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>+-----------------------------+---------------+---------------+
