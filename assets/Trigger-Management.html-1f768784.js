...
<span class="token punctuation">)</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>The above SQL statement creates a trigger named triggerTest:</p>`,14),g=e("li",null,"The trigger is stateless.",-1),h=e("li",null,"Fires before insertion.",-1),u={href:"http://root.sg",target:"_blank",rel:"noopener noreferrer"},m=e("li",null,[t("The implemented trigger class is named "),e("code",null,"org.apache.iotdb.trigger.ClusterAlertingExample")],-1),v={href:"http://jar/ClusterAlertingExample.jar",target:"_blank",rel:"noopener noreferrer"},T=e("li",null,"When creating the trigger instance, two parameters, name and limit, are passed in.",-1),b=a(`<h2 id="drop-trigger" tabindex="-1"><a class="header-anchor" href="#drop-trigger" aria-hidden="true">#</a> Drop Trigger</h2><p>The trigger can be dropped by specifying the trigger ID. During the process of dropping the trigger, the <code>onDrop</code> interface of the trigger will be called only once.</p><p>The SQL syntax is:</p><div class="language-sql line-numbers-mode" data-ext="sql"><pre class="language-sql"><code><span class="token comment">// Drop Trigger</span>
dropTrigger
...
`),p,e("ul",null,[g,h,e("li",null,[t("Listens on path pattern "),e("a",u,[t("root.sg"),s(n)]),t(".**")]),m,e("li",null,[t("The JAR package URI is "),e("a",v,[t("http://jar/ClusterAlertingExample.jar"),s(n)])]),T]),b])}const S=i(c,[["render",k],["__file","Trigger-Management.html.vue"]]);export{S as default};