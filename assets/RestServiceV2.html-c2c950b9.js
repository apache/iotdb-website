import{_ as o,r as p,o as l,c as i,a as u,d as s,e as n,b as t,f as a}from"./app-bb4a7608.js";const c={},r=a(`<h1 id="restful-services" tabindex="-1"><a class="header-anchor" href="#restful-services" aria-hidden="true">#</a> RESTful Services</h1><p>IoTDB&#39;s RESTful services can be used for query, write, and management operations, using the OpenAPI standard to define interfaces and generate frameworks.</p><h2 id="enable-restful-services" tabindex="-1"><a class="header-anchor" href="#enable-restful-services" aria-hidden="true">#</a> Enable RESTful Services</h2><p>RESTful services are disabled by default.</p><ul><li><p>Developer</p><p>Find the <code>IoTDBrestServiceConfig</code> class under <code>org.apache.iotdb.db.conf.rest</code> in the sever module, and modify <code>enableRestService=true</code>.</p></li><li><p>User</p><p>Find the <code>conf/iotdb.rest.properties</code> file under the IoTDB installation directory and set <code>enable_rest_service</code> to <code>true</code> to enable the module.</p><div class="language-properties line-numbers-mode" data-ext="properties"><pre class="language-properties"><code><span class="token key attr-name">enable_rest_service</span><span class="token punctuation">=</span><span class="token value attr-value">true</span>
...
<span class="token punctuation">}</span>
  ...
  <span class="token property">&quot;message&quot;</span><span class="token operator">:</span> <span class="token string">&quot;SUCCESS_STATUS&quot;</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="insertrecords" tabindex="-1"><a class="header-anchor" href="#insertrecords" aria-hidden="true">#</a> insertRecords</h3><p>Request method: <code>POST</code></p><p>Request header: <code>application/json</code></p>`,11),y={href:"http://ip",target:"_blank",rel:"noopener noreferrer"},f=a(`<p>Parameter Description:</p><table><thead><tr><th style="text-align:left;">parameter name</th><th style="text-align:left;">parameter type</th><th style="text-align:left;">is required</th><th style="text-align:left;">parameter describe</th></tr></thead><tbody><tr><td style="text-align:left;">timestamps</td><td style="text-align:left;">array</td><td style="text-align:left;">yes</td><td style="text-align:left;">Time column</td></tr><tr><td style="text-align:left;">measurements_list</td><td style="text-align:left;">array</td><td style="text-align:left;">yes</td><td style="text-align:left;">The name of the measuring point</td></tr><tr><td style="text-align:left;">data_types_list</td><td style="text-align:left;">array</td><td style="text-align:left;">yes</td><td style="text-align:left;">The data type</td></tr><tr><td style="text-align:left;">values_list</td><td style="text-align:left;">array</td><td style="text-align:left;">yes</td><td style="text-align:left;">Value columns, the values in each column can be <code>null</code></td></tr><tr><td style="text-align:left;">devices</td><td style="text-align:left;">string</td><td style="text-align:left;">yes</td><td style="text-align:left;">Device name</td></tr></tbody></table><p>Example request:</p><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token function">curl</span> <span class="token parameter variable">-H</span> <span class="token string">&quot;Content-Type:application/json&quot;</span> <span class="token parameter variable">-H</span> <span class="token string">&quot;Authorization:Basic cm9vdDpyb290&quot;</span> <span class="token parameter variable">-X</span> POST <span class="token parameter variable">--data</span> <span class="token string">&#39;{&quot;timestamps&quot;:[1635232113960,1635232151960,1635232143960,1635232143960],&quot;measurements_list&quot;:[[&quot;s33&quot;,&quot;s44&quot;],[&quot;s55&quot;,&quot;s66&quot;],[&quot;s77&quot;,&quot;s88&quot;],[&quot;s771&quot;,&quot;s881&quot;]],&quot;data_types_list&quot;:[[&quot;INT32&quot;,&quot;INT64&quot;],[&quot;FLOAT&quot;,&quot;DOUBLE&quot;],[&quot;FLOAT&quot;,&quot;DOUBLE&quot;],[&quot;BOOLEAN&quot;,&quot;TEXT&quot;]],&quot;values_list&quot;:[[1,11],[2.1,2],[4,6],[false,&quot;cccccc&quot;]],&quot;devices&quot;:[&quot;root.s1&quot;,&quot;root.s1&quot;,&quot;root.s1&quot;,&quot;root.s3&quot;]}&#39;</span> http://127.0.0.1:18080/rest/v2/insertRecords
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p>Sample response:</p><table><thead><tr><th style="text-align:left;">parameter name</th><th style="text-align:left;">parameter type</th><th style="text-align:left;">parameter describe</th></tr></thead><tbody><tr><td style="text-align:left;">code</td><td style="text-align:left;">integer</td><td style="text-align:left;">status code</td></tr><tr><td style="text-align:left;">message</td><td style="text-align:left;">string</td><td style="text-align:left;">message</td></tr></tbody></table><p>Sample response:</p><div class="language-json line-numbers-mode" data-ext="json"><pre class="language-json"><code><span class="token punctuation">{</span>
  <span class="token property">&quot;code&quot;</span><span class="token operator">:</span> <span class="token number">200</span><span class="token punctuation">,</span>
  <span class="token property">&quot;message&quot;</span><span class="token operator">:</span> <span class="token string">&quot;SUCCESS_STATUS&quot;</span>
<span class="token punctuation">}</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div>`,36);function x(T,_){const e=p("ExternalLinkIcon");return l(),i("div",null,[u(`
