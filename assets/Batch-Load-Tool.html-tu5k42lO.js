...
`),h,u,T,n("p",null,[e("TsFile 是在 IoTDB 中使用的时间序列的文件格式，您可以通过CLI等工具直接将存有时间序列的一个或多个 TsFile 文件导入到另外一个正在运行的IoTDB实例中。具体操作方式请参考"),o(t,{to:"/zh/UserGuide/V1.2.x/stage/Maintenance-Tools/Load-Tsfile.html"},{default:i(()=>[e("TsFile 导入工具")]),_:1}),e("，"),o(t,{to:"/zh/UserGuide/V1.2.x/stage/Maintenance-Tools/TsFile-Load-Export-Tool.html"},{default:i(()=>[e("TsFile 导出工具")]),_:1}),e("。")]),f,n("p",null,[e("CSV 是以纯文本形式存储表格数据，您可以在CSV文件中写入多条格式化的数据，并批量的将这些数据导入到 IoTDB 中，在导入数据之前，建议在IoTDB中创建好对应的元数据信息。如果忘记创建元数据也不要担心，IoTDB 可以自动将CSV中数据推断为其对应的数据类型，前提是你每一列的数据类型必须唯一。除单个文件外，此工具还支持以文件夹的形式导入多个 CSV 文件，并且支持设置如时间精度等优化参数。具体操作方式请参考 "),o(t,{to:"/zh/UserGuide/V1.2.x/stage/Maintenance-Tools/CSV-Tool.html"},{default:i(()=>[e("CSV 导入导出工具")]),_:1}),e("。")])])}const I=s(l,[["render",p],["__file","Batch-Load-Tool.html.vue"]]);export{I as default};
