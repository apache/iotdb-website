...
|root.sg1.d1.s1| null|     root.sg1|   INT32|     RLE|     SNAPPY|{&quot;tag1&quot;:&quot;v1&quot;,&quot;tag2&quot;:&quot;v2&quot;}|{&quot;attr2&quot;:&quot;v2&quot;,&quot;attr1&quot;:&quot;v1&quot;}|    null|               null|
+--------------+-----+-------------+--------+--------+-----------+-------------------------+---------------------------+--------+-------------------+
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>上述对时间序列标签、属性的更新等操作都支持。</p>`,34);function g(p,E){const i=o("RouterLink");return d(),r("div",null,[u(`
...
`),v,n("p",null,[e("详细的数据类型与编码方式的对应列表请参见 "),l(i,{to:"/zh/UserGuide/V1.2.x/Basic-Concept/Encoding.html"},{default:s(()=>[e("编码方式")]),_:1}),e("。")]),m,n("blockquote",null,[n("p",null,[e("IoTDB 同时支持在查询语句中 "),l(i,{to:"/zh/UserGuide/V1.2.x/Reference/SQL-Reference.html#%E6%95%B0%E6%8D%AE%E7%AE%A1%E7%90%86%E8%AF%AD%E5%8F%A5"},{default:s(()=>[e("使用 AS 函数")]),_:1}),e(" 设置别名。二者的区别在于：AS 函数设置的别名用于替代整条时间序列名，且是临时的，不与时间序列绑定；而上文中的别名只作为传感器的别名，与其绑定且可与原传感器名等价使用。")])]),b])}const I=a(c,[["render",g],["__file","Timeseries.html.vue"]]);export{I as default};
