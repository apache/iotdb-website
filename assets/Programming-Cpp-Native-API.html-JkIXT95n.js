import{_ as l,r as o,o as i,c as p,a as c,d as n,e as s,b as e,f as t}from"./app-1BKhssE1.js";const d={},r=t('<h1 id="c-原生接口" tabindex="-1"><a class="header-anchor" href="#c-原生接口" aria-hidden="true">#</a> C++ 原生接口</h1><h2 id="依赖" tabindex="-1"><a class="header-anchor" href="#依赖" aria-hidden="true">#</a> 依赖</h2><ul><li>Java 8+</li><li>Maven 3.5+</li><li>Flex</li><li>Bison 2.7+</li><li>Boost 1.56+</li><li>OpenSSL 1.0+</li><li>GCC 5.5.0+</li></ul><h2 id="安装" tabindex="-1"><a class="header-anchor" href="#安装" aria-hidden="true">#</a> 安装</h2><h3 id="安装相关依赖" tabindex="-1"><a class="header-anchor" href="#安装相关依赖" aria-hidden="true">#</a> 安装相关依赖</h3>',5),u=t(`<li><p><strong>MAC</strong></p><ol><li><p>安装 Bison ：Mac 环境下预安装了 Bison 2.3 版本，但该版本过低不能够用来编译 Thrift。</p><p>使用 Bison 2.3 版本会报以下错误：<br><code>invalid directive: &#39;%code&#39;</code></p><p>使用下面 brew 命令更新 bison 版本：</p><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code>brew <span class="token function">install</span> bison
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p>使用 yum 安装的 GCC、Boost 版本过低，在编译时会报错，需自行安装或升级。</p></li>`,3),v=n("p",null,[n("strong",null,"Windows")],-1),m=n("p",null,"构建编译环境",-1),g=n("li",null,"安装 MS Visual Studio（推荐安装 2019 版本）：安装时需要勾选 Visual Studio C/C++ IDE and compiler(supporting CMake, Clang, MinGW)。",-1),k={href:"https://cmake.org/download/",target:"_blank",rel:"noopener noreferrer"},b=n("p",null,"下载安装 Flex、Bison",-1),h={href:"https://sourceforge.net/projects/winflexbison/",target:"_blank",rel:"noopener noreferrer"},f=n("li",null,"下载后需要将可执行文件重命名为 flex.exe 和 bison.exe 以保证编译时能够被找到，添加可执行文件的目录到 PATH 环境变量中。",-1),y=n("p",null,"安装 Boost",-1),w={href:"https://www.boost.org/users/download/",target:"_blank",rel:"noopener noreferrer"},x=n("li",null,"本地编译 Boost ：依次执行 bootstrap.bat 和 b2.exe 。",-1),T=n("p",null,"安装 OpenSSL",-1),S={href:"http://slproweb.com/products/Win32OpenSSL.html",target:"_blank",rel:"noopener noreferrer"},_=t(`<h3 id="执行编译" tabindex="-1"><a class="header-anchor" href="#执行编译" aria-hidden="true">#</a> 执行编译</h3><p>从 git 克隆源代码:</p><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token function">git</span> clone https://github.com/apache/iotdb.git
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><ul><li>CMake 根据不同编译平台使用不同的生成器，需添加<code>-Dcmake.generator=&quot;&quot;</code>选项来指定使用的生成器名称，例如： <code>-Dcmake.generator=&quot;Visual Studio 16 2019&quot;</code>。（通过<code>cmake --help</code>命令可以查看 CMake 支持的生成器列表）</li><li>为了帮助 CMake 找到本地安装好的 Boost，在编译命令中需添加相关参数，例如：<code>-DboostIncludeDir=&quot;C:\\Program Files (x86)\\boost_1_78_0&quot; -DboostLibraryDir=&quot;C:\\Program Files (x86)\\boost_1_78_0\\stage\\lib&quot;</code></li></ul></li></ul><p>编译成功后，打包好的 zip 文件位于 <code>client-cpp/target/client-cpp-1.3.0-SNAPSHOT-cpp-\${os}.zip</code></p><h3 id="编译-q-a" tabindex="-1"><a class="header-anchor" href="#编译-q-a" aria-hidden="true">#</a> 编译 Q&amp;A</h3><p>Q：编译报错<code>undefined reference to &#39;_libc_sinle_thread&#39;</code>如何处理？</p><p>A：</p><ul><li>删除 C++client 的 pom.xml 里关于test相关的编译和运行操作，修改后的 pom 如下所示：</li></ul><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>      
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="iotdb-sql-接口" tabindex="-1"><a class="header-anchor" href="#iotdb-sql-接口" aria-hidden="true">#</a> IoTDB-SQL 接口</h3><ul><li>执行查询语句</li></ul><div class="language-cpp line-numbers-mode" data-ext="cpp"><pre class="language-cpp"><code><span class="token keyword">void</span> <span class="token function">executeNonQueryStatement</span><span class="token punctuation">(</span><span class="token keyword">const</span> std<span class="token double-colon punctuation">::</span>string <span class="token operator">&amp;</span>sql<span class="token punctuation">)</span><span class="token punctuation">;</span>
...
`),r,n("ul",null,[u,n("li",null,[v,n("ol",null,[n("li",null,[m,n("ul",null,[g,n("li",null,[s("下载安装 "),n("a",k,[s("CMake"),e(a)]),s(" 。")])])]),n("li",null,[b,n("ul",null,[n("li",null,[s("下载 "),n("a",h,[s("Win_Flex_Bison"),e(a)]),s(" 。")]),f])]),n("li",null,[y,n("ul",null,[n("li",null,[s("下载 "),n("a",w,[s("Boost"),e(a)]),s(" 。")]),x])]),n("li",null,[T,n("ul",null,[n("li",null,[s("下载安装 "),n("a",S,[s("OpenSSL"),e(a)]),s(" 。")])])])])])]),_,n("ol",null,[n("li",null,[n("p",null,[s("MAC：本地 Maven 编译 Thrift 时如出现以下链接的问题，可以尝试将 xcode-commandline 版本从 12 降低到 11.5"),I,n("a",D,[s("https://stackoverflow.com/questions/63592445/ld-unsupported-tapi-file-type-tapi-tbd-in-yaml-file/65518087#65518087"),e(a)])])]),C])])}const F=l(d,[["render",L],["__file","Programming-Cpp-Native-API.html.vue"]]);export{F as default};
