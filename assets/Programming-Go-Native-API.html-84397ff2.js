import{_ as n,M as e,N as s,af as a,aT as i}from"./framework-ae7271bd.js";const l={},o=i(`<h2 id="go-原生接口" tabindex="-1"><a class="header-anchor" href="#go-原生接口" aria-hidden="true">#</a> Go 原生接口</h2><h3 id="依赖" tabindex="-1"><a class="header-anchor" href="#依赖" aria-hidden="true">#</a> 依赖</h3><ul><li>golang &gt;= 1.13</li><li>make &gt;= 3.0</li><li>curl &gt;= 7.1.1</li><li>thrift 0.13.x</li><li>Linux、Macos 或其他类 unix 系统</li><li>Windows+bash(WSL、cygwin、Git Bash)</li></ul><h3 id="安装方法" tabindex="-1"><a class="header-anchor" href="#安装方法" aria-hidden="true">#</a> 安装方法</h3><ul><li>通过 go mod</li></ul><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token comment"># 切换到 GOPATH 的 HOME 路径，启用 Go Modules 功能</span>
...
<span class="token comment"># 编译并运行程序</span>
go run session_example.go
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="注意-go原生客户端session不是线程安全的-强烈不建议在多线程场景下应用。如有多线程应用场景-请使用session-pool" tabindex="-1"><a class="header-anchor" href="#注意-go原生客户端session不是线程安全的-强烈不建议在多线程场景下应用。如有多线程应用场景-请使用session-pool" aria-hidden="true">#</a> 注意：GO原生客户端Session不是线程安全的，强烈不建议在多线程场景下应用。如有多线程应用场景，请使用Session Pool.</h4>`,9);function t(c,d){return e(),s("div",null,[a(`
