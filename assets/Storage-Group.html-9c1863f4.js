import{_ as r,C as n,O as i,P as d,ah as l,Q as c,U as e,ai as a,ae as o,aW as s}from"./framework-5609642f.js";const g={},u=s(`<h1 id="storage-group-management" tabindex="-1"><a class="header-anchor" href="#storage-group-management" aria-hidden="true">#</a> Storage Group Management</h1><h2 id="create-storage-group" tabindex="-1"><a class="header-anchor" href="#create-storage-group" aria-hidden="true">#</a> Create Storage Group</h2><p>According to the storage model we can set up the corresponding storage group. Two SQL statements are supported for creating storage groups, as follows:</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>IoTDB &gt; set storage group to root.ln
