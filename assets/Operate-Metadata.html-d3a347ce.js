...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div><p>SHOW ALL TTL 这个例子会给出所有 database 的 TTL。 SHOW TTL ON root.ln,root.sgcc,root.DB 这个例子会显示指定的三个 database 的 TTL。 注意：没有设置 TTL 的 database 的 TTL 将显示为 null。</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>IoTDB&gt; show all ttl
+-------------+-------+
|     database|ttl(ms)|
+-------------+-------+
|      root.ln|3600000|
...
Total line number = 1
It costs 0.004s
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,80);function g(h,T){const n=c("RouterLink");return d(),r("div",null,[o(`
...
`),v,a("p",null,[e("在 database 创建后，我们可以使用 "),s(n,{to:"/zh/UserGuide/V1.2.x/Reference/SQL-Reference.html"},{default:i(()=>[e("SHOW DATABASES")]),_:1}),e(" 语句和 "),s(n,{to:"/zh/UserGuide/V1.2.x/Reference/SQL-Reference.html"},{default:i(()=>[e("SHOW DATABASES <PathPattern>")]),_:1}),e(" 来查看 database，SQL 语句如下所示：")]),p,a("p",null,[e("详细的数据类型与编码方式的对应列表请参见 "),s(n,{to:"/zh/UserGuide/V1.2.x/Basic-Concept/Encoding.html"},{default:i(()=>[e("编码方式")]),_:1}),e("。")]),m,a("blockquote",null,[a("p",null,[e("IoTDB 同时支持在查询语句中 "),s(n,{to:"/zh/UserGuide/V1.2.x/Reference/SQL-Reference.html#%E6%95%B0%E6%8D%AE%E7%AE%A1%E7%90%86%E8%AF%AD%E5%8F%A5"},{default:i(()=>[e("使用 AS 函数")]),_:1}),e(" 设置别名。二者的区别在于：AS 函数设置的别名用于替代整条时间序列名，且是临时的，不与时间序列绑定；而上文中的别名只作为传感器的别名，与其绑定且可与原传感器名等价使用。")])]),b])}const x=l(u,[["render",g],["__file","Operate-Metadata.html.vue"]]);export{x as default};
