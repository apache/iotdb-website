...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div>`,13);function h(_,b){const t=o("ExternalLinkIcon");return r(),d("div",null,[l(`
...
`),u,i("p",null,[e("Yes. IoTDB has intense integration with Open Source Ecosystem. IoTDB supports "),i("a",m,[e("Hadoop"),n(t)]),e(", "),i("a",p,[e("Spark"),n(t)]),e(" and "),i("a",v,[e("Grafana"),n(t)]),e(" visualization tool.")]),g])}const f=a(c,[["render",h],["__file","Frequently-asked-questions.html.vue"]]);export{f as default};