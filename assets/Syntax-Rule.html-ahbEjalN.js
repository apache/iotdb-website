import{_ as d,r as s,o,c as r,a as c,d as n,e,b as a,w as p,f as i}from"./app-QUK6SVpf.js";const u={},v=i(`<h1 id="语法约定" tabindex="-1"><a class="header-anchor" href="#语法约定" aria-hidden="true">#</a> 语法约定</h1><h2 id="字面值常量" tabindex="-1"><a class="header-anchor" href="#字面值常量" aria-hidden="true">#</a> 字面值常量</h2><p>该部分对 IoTDB 中支持的字面值常量进行说明，包括字符串常量、数值型常量、时间戳常量、布尔型常量和空值。</p><h3 id="字符串常量" tabindex="-1"><a class="header-anchor" href="#字符串常量" aria-hidden="true">#</a> 字符串常量</h3><p>在 IoTDB 中，字符串是由<strong>单引号（<code>&#39;</code>）或双引号（<code>&quot;</code>）字符括起来的字符序列</strong>。示例如下：</p><div class="language-Plain%20Text line-numbers-mode" data-ext="Plain%20Text"><pre class="language-Plain%20Text"><code>&#39;a string&#39;
&quot;another string&quot;
...
<span class="token operator">+</span><span class="token comment">-----------------------------+-----------+-----+</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div></li><li><p>用于表示键值对，键值对的键和值可以被定义成常量（包括字符串）或者标识符，具体请参考键值对章节。</p></li><li><p>时间序列路径中对于 database 级别以外的层级路径支持含有&quot;*&quot;创建，如 root.db.<code>*</code>。</p></li></ul><h2 id="关键字" tabindex="-1"><a class="header-anchor" href="#关键字" aria-hidden="true">#</a> 关键字</h2><p>关键字是在 SQL 具有特定含义的词，可以作为标识符。保留字是关键字的一个子集，保留字不能用于标识符。</p>`,23),k={href:"https://iotdb.apache.org/zh/UserGuide/Master/Reference/Keywords.html",target:"_blank",rel:"noopener noreferrer"},h=n("h2",{id:"词法与文法详细定义",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#词法与文法详细定义","aria-hidden":"true"},"#"),e(" 词法与文法详细定义")],-1),b=n("p",null,"请阅读代码仓库中的词法和语法描述文件：",-1),g=n("p",null,[e("词法文件："),n("code",null,"antlr/src/main/antlr4/org/apache/iotdb/db/qp/sql/IoTDBSqlLexer.g4")],-1),w=n("p",null,[e("语法文件："),n("code",null,"antlr/src/main/antlr4/org/apache/iotdb/db/qp/sql/IoTDBSqlParser.g4")],-1);function E(T,S){const t=s("RouterLink"),l=s("ExternalLinkIcon");return o(),r("div",null,[c(`
...
`),v,n("p",null,[e("时间戳是一个数据到来的时间点，在 IoTDB 中分为绝对时间戳和相对时间戳。详细信息可参考 "),a(t,{to:"/zh/UserGuide/latest/Basic-Concept/Data-Type.html"},{default:p(()=>[e("数据类型文档")]),_:1}),e("。")]),m,n("p",null,[e("关于 IoTDB 的关键字列表，可以查看 "),n("a",k,[e("关键字"),a(l)]),e(" 。")]),h,b,g,w])}const L=d(u,[["render",E],["__file","Syntax-Rule.html.vue"]]);export{L as default};
