...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div><p>Database 节点名只支持中英文字符、数字、下划线的组合，如果想设置为纯数字或者包含其他字符，需要用反引号(\`\`)把 database 名称引起来。</p><p>还需注意，如果在 Windows 系统上部署，database 名是大小写不敏感的。例如同时创建<code>root.ln</code> 和 <code>root.LN</code> 是不被允许的。</p><h3 id="查看数据库" tabindex="-1"><a class="header-anchor" href="#查看数据库" aria-hidden="true">#</a> 查看数据库</h3>`,12),p=t(`<div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>IoTDB&gt; show databases
...
`),v,s("p",null,[e("在 database 创建后，我们可以使用 "),a(n,{to:"/zh/UserGuide/Master/Reference/SQL-Reference.html"},{default:i(()=>[e("SHOW DATABASES")]),_:1}),e(" 语句和 "),a(n,{to:"/zh/UserGuide/Master/Reference/SQL-Reference.html"},{default:i(()=>[e("SHOW DATABASES <PathPattern>")]),_:1}),e(" 来查看 database，SQL 语句如下所示：")]),p,s("p",null,[e("详细的数据类型与编码方式的对应列表请参见 "),a(n,{to:"/zh/UserGuide/Master/Basic-Concept/Encoding.html"},{default:i(()=>[e("编码方式")]),_:1}),e("。")]),m,s("blockquote",null,[s("p",null,[e("IoTDB 同时支持在查询语句中 "),a(n,{to:"/zh/UserGuide/Master/Reference/SQL-Reference.html#%E6%95%B0%E6%8D%AE%E7%AE%A1%E7%90%86%E8%AF%AD%E5%8F%A5"},{default:i(()=>[e("使用 AS 函数")]),_:1}),e(" 设置别名。二者的区别在于：AS 函数设置的别名用于替代整条时间序列名，且是临时的，不与时间序列绑定；而上文中的别名只作为传感器的别名，与其绑定且可与原传感器名等价使用。")])]),b])}const x=l(u,[["render",g],["__file","Operate-Metadata.html.vue"]]);export{x as default};
