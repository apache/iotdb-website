...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p><strong>How to handle error <code>IndexOutOfBoundsException</code> from <code>org.apache.ratis.grpc.server.GrpcLogAppender</code>?</strong></p><p>It is an internal error introduced by Ratis 2.4.1 dependency, and we can safely ignore this exception as it will not affect normal operations. We will fix this message in the incoming releases.</p>`,15);function h(_,b){const i=l("ExternalLinkIcon");return o(),r("div",null,[d(`
...
`),u,n("p",null,[e("Yes. IoTDB has intense integration with Open Source Ecosystem. IoTDB supports "),n("a",p,[e("Hadoop"),t(i)]),e(", "),n("a",m,[e("Spark"),t(i)]),e(" and "),n("a",v,[e("Grafana"),t(i)]),e(" visualization tool.")]),g])}const f=a(c,[["render",h],["__file","Frequently-asked-questions.html.vue"]]);export{f as default};