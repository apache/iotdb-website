...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div>`,21);function x(f,I){const a=o("ExternalLinkIcon");return t(),s("div",null,[r(`
...
`),p,e("ul",null,[e("li",null,[e("p",null,[n("使用 "),u,n(" 编译分布式模块或直接到 "),e("a",v,[n("官网"),l(a)]),n(" 下载最新版本。")])]),m,g,b,_]),h])}const w=d(c,[["render",x],["__file","Cluster-Setup-Example.html.vue"]]);export{w as default};