import{_ as i,C as d,O as l,P as r,ah as o,Q as c,U as e,ai as n,ae as s,aW as t}from"./framework-374e0e89.js";const u={},v=t(`<h1 id="database-management" tabindex="-1"><a class="header-anchor" href="#database-management" aria-hidden="true">#</a> Database Management</h1><h2 id="create-database" tabindex="-1"><a class="header-anchor" href="#create-database" aria-hidden="true">#</a> Create Database</h2><p>According to the storage model we can set up the corresponding database. Two SQL statements are supported for creating databases, as follows:</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>IoTDB &gt; create database root.ln
...
`),v,c("p",null,[e("After creating the database, we can use the "),n(a,{to:"/UserGuide/V1.2.x/Reference/SQL-Reference.html"},{default:s(()=>[e("SHOW DATABASES")]),_:1}),e(" statement and "),n(a,{to:"/UserGuide/V1.2.x/Reference/SQL-Reference.html"},{default:s(()=>[e("SHOW DATABASES <PathPattern>")]),_:1}),e(" to view the databases. The SQL statements are as follows:")]),b])}const f=i(u,[["render",m],["__file","Database.html.vue"]]);export{f as default};