import{_ as o,r as i,o as c,c as p,a as l,d as s,e as n,b as e,f as t}from"./app-q7RXDTub.js";const r={},d=s("h1",{id:"installation-by-docker",tabindex:"-1"},[s("a",{class:"header-anchor",href:"#installation-by-docker","aria-hidden":"true"},"#"),n(" Installation by Docker")],-1),u={href:"https://hub.docker.com/r/apache/iotdb",target:"_blank",rel:"noopener noreferrer"},k=s("br",null,null,-1),v=t(`<h2 id="have-a-try" tabindex="-1"><a class="header-anchor" href="#have-a-try" aria-hidden="true">#</a> Have a try</h2><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token comment"># get IoTDB official image</span>
