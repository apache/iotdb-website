...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div>`,11),f={href:"https://iotdb.apache.org/zh/UserGuide/V1.0.x/Administration-Management/Administration.html",target:"_blank",rel:"noopener noreferrer"},D=t('<h2 id="基础配置" tabindex="-1"><a class="header-anchor" href="#基础配置" aria-hidden="true">#</a> 基础配置</h2><p>配置文件在&quot;conf&quot;文件夹下，包括：</p><ul><li>环境配置模块 (<code>datanode-env.bat</code>, <code>datanode-env.sh</code>),</li><li>系统配置模块 (<code>iotdb-datanode.properties</code>)</li><li>日志配置模块 (<code>logback.xml</code>).</li></ul>',3);function w(B,A){const s=l("RouterLink"),a=l("ExternalLinkIcon");return o(),c("div",null,[u(`
...
`),p,e("p",null,[n("本文将介绍关于 IoTDB 使用的基本流程，如果需要更多信息，请浏览我们官网的 "),i(s,{to:"/zh/UserGuide/V1.2.x/IoTDB-Introduction/What-is-IoTDB.html"},{default:d(()=>[n("指引")]),_:1}),n(".")]),m,b,h,g,x,e("ul",null,[_,e("li",null,[e("p",null,[n("二进制可运行程序：请从 "),e("a",T,[n("下载"),i(a)]),n(" 页面下载最新的安装包，解压后即完成安装。")])]),e("li",null,[e("p",null,[n("使用 Docker 镜像：dockerfile 文件位于"),e("a",I,[n("github"),i(a)])])])]),S,e("p",null,[n("想要浏览更多 IoTDB 数据库支持的命令，请浏览 "),i(s,{to:"/zh/UserGuide/V1.2.x/Reference/SQL-Reference.html"},{default:d(()=>[n("SQL Reference")]),_:1}),n(".")]),E,e("p",null,[n("权限管理的具体内容可以参考："),e("a",f,[n("权限管理"),i(a)])]),D])}const O=r(v,[["render",w],["__file","QuickStart.html.vue"]]);export{O as default};
