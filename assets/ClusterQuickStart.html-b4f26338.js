import{_ as d,C as r,O as s,P as a,ah as o,Q as e,U as n,ai as l,aW as t}from"./framework-62ad666a.js";const c={},u=t(`<h2 id="quick-start" tabindex="-1"><a class="header-anchor" href="#quick-start" aria-hidden="true">#</a> Quick Start</h2><p>This article uses a local environment as an example to illustrate how to start, expand, and shrink an IoTDB Cluster.</p><p><strong>Notice: This document is a tutorial for deploying in a pseudo-cluster environment using different local ports, and is for exercise only. In real deployment scenarios, you only need to configure the IPV4 address or domain name of the server, and do not need to change the Node ports.</strong></p><h3 id="_1-prepare-the-start-environment" tabindex="-1"><a class="header-anchor" href="#_1-prepare-the-start-environment" aria-hidden="true">#</a> 1. Prepare the Start Environment</h3><p>Unzip the apache-iotdb-1.0.0-all-bin.zip file to cluster0 folder.</p><h3 id="_2-start-a-minimum-cluster" tabindex="-1"><a class="header-anchor" href="#_2-start-a-minimum-cluster" aria-hidden="true">#</a> 2. Start a Minimum Cluster</h3><p>Start the Cluster version with one ConfigNode and one DataNode(1C1D), and the default number of replicas is one.</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>./cluster0/sbin/start-confignode.sh
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div>`,11),h={href:"https://iotdb.apache.org/UserGuide/Master/Maintenance-Tools/Maintenance-Command.html#show-all-node-information",target:"_blank",rel:"noopener noreferrer"},v=t(`<div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>IoTDB&gt; show cluster details
+------+----------+-------+---------------+------------+-------------------+----------+-------+--------+-------------------+-----------------+
...
Total line number = 4
It costs 0.005s
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,28);function m(g,p){const i=r("ExternalLinkIcon");return s(),a("div",null,[o(`
...
`),u,e("ul",null,[e("li",null,[n("Execute the "),e("a",h,[n("show cluster details"),l(i)]),n(" command on the Cli. The result is shown below:")])]),v])}const _=d(c,[["render",m],["__file","ClusterQuickStart.html.vue"]]);export{_ as default};