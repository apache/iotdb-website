...
`),u,d("p",null,[e("The specified syntax for SDT is detailed in "),l(n,{to:"/UserGuide/latest/Reference/SQL-Reference.html"},{default:c(()=>[e("Create Timeseries Statement")]),_:1}),e(".")]),p])}const g=s(m,[["render",h],["__file","Deadband-Process.html.vue"]]);export{g as default};
