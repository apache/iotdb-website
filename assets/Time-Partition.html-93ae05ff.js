...
`),m,e("p",null,[t("使用时间分区功能时，建议同时打开 Memtable 的定时刷盘功能，共 6 个相关配置参数（详情见 "),o(i,{to:"/zh/UserGuide/Master/Reference/DataNode-Config-Manual.html"},{default:d(()=>[t("timed_flush配置项")]),_:1}),t("）。")]),p])}const x=a(c,[["render",u],["__file","Time-Partition.html.vue"]]);export{x as default};