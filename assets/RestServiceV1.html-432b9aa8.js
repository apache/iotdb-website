...
<span class="token punctuation">}</span>
  ...
  <span class="token property">&quot;message&quot;</span><span class="token operator">:</span> <span class="token string">&quot;SUCCESS_STATUS&quot;</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="inserttablet" tabindex="-1"><a class="header-anchor" href="#inserttablet" aria-hidden="true">#</a> insertTablet</h3><p>请求方式：<code>POST</code></p><p>请求头：<code>application/json</code></p>`,11),g={href:"http://ip",target:"_blank",rel:"noopener noreferrer"},h=a(`<p>参数说明:</p><table><thead><tr><th>参数名称</th><th>参数类型</th><th>是否必填</th><th>参数描述</th></tr></thead><tbody><tr><td>timestamps</td><td>array</td><td>是</td><td>时间列</td></tr><tr><td>measurements</td><td>array</td><td>是</td><td>测点名称</td></tr><tr><td>dataTypes</td><td>array</td><td>是</td><td>数据类型</td></tr><tr><td>values</td><td>array</td><td>是</td><td>值列，每一列中的值可以为 <code>null</code></td></tr><tr><td>isAligned</td><td>boolean</td><td>是</td><td>是否是对齐时间序列</td></tr><tr><td>deviceId</td><td>string</td><td>是</td><td>设备名称</td></tr></tbody></table><p>请求示例：</p><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token function">curl</span> <span class="token parameter variable">-H</span> <span class="token string">&quot;Content-Type:application/json&quot;</span> <span class="token parameter variable">-H</span> <span class="token string">&quot;Authorization:Basic cm9vdDpyb290&quot;</span> <span class="token parameter variable">-X</span> POST <span class="token parameter variable">--data</span> <span class="token string">&#39;{&quot;timestamps&quot;:[1635232143960,1635232153960],&quot;measurements&quot;:[&quot;s3&quot;,&quot;s4&quot;],&quot;dataTypes&quot;:[&quot;INT32&quot;,&quot;BOOLEAN&quot;],&quot;values&quot;:[[11,null],[false,true]],&quot;isAligned&quot;:false,&quot;deviceId&quot;:&quot;root.sg27&quot;}&#39;</span> http://127.0.0.1:18080/rest/v1/insertTablet
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p>响应参数：</p><table><thead><tr><th>参数名称</th><th>参数类型</th><th>参数描述</th></tr></thead><tbody><tr><td>code</td><td>integer</td><td>状态码</td></tr><tr><td>message</td><td>string</td><td>信息提示</td></tr></tbody></table><p>响应示例：</p><div class="language-json line-numbers-mode" data-ext="json"><pre class="language-json"><code><span class="token punctuation">{</span>
  <span class="token property">&quot;code&quot;</span><span class="token operator">:</span> <span class="token number">200</span><span class="token punctuation">,</span>
  <span class="token property">&quot;message&quot;</span><span class="token operator">:</span> <span class="token string">&quot;SUCCESS_STATUS&quot;</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="insertrecords" tabindex="-1"><a class="header-anchor" href="#insertrecords" aria-hidden="true">#</a> insertRecords</h3><p>请求方式：<code>POST</code></p><p>请求头：<code>application/json</code></p>`,11),y={href:"http://ip",target:"_blank",rel:"noopener noreferrer"},T=a(`<p>参数说明:</p><table><thead><tr><th>参数名称</th><th>参数类型</th><th>是否必填</th><th>参数描述</th></tr></thead><tbody><tr><td>timestamps</td><td>array</td><td>是</td><td>时间列</td></tr><tr><td>measurementsList</td><td>array</td><td>是</td><td>测点名称</td></tr><tr><td>dataTypesList</td><td>array</td><td>是</td><td>数据类型</td></tr><tr><td>valuesList</td><td>array</td><td>是</td><td>值列，每一列中的值可以为 <code>null</code></td></tr><tr><td>deviceIds</td><td>string</td><td>是</td><td>设备名称</td></tr></tbody></table><p>请求示例：</p><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token function">curl</span> <span class="token parameter variable">-H</span> <span class="token string">&quot;Content-Type:application/json&quot;</span> <span class="token parameter variable">-H</span> <span class="token string">&quot;Authorization:Basic cm9vdDpyb290&quot;</span> <span class="token parameter variable">-X</span> POST <span class="token parameter variable">--data</span> <span class="token string">&#39;{&quot;timestamps&quot;:[1635232113960,1635232151960,1635232151860,1635232152960],&quot;measurementsList&quot;:[[&quot;s33&quot;,&quot;s44&quot;],[&quot;s55&quot;,&quot;s66&quot;],[&quot;s77&quot;,&quot;s88&quot;],[&quot;s771&quot;,&quot;s881&quot;]],&quot;dataTypesList&quot;:[[&quot;INT32&quot;,&quot;INT64&quot;],[&quot;FLOAT&quot;,&quot;DOUBLE&quot;],[&quot;FLOAT&quot;,&quot;DOUBLE&quot;],[&quot;BOOLEAN&quot;,&quot;TEXT&quot;]],&quot;valuesList&quot;:[[1,11],[2.1,2],[4,6],[false,&quot;cccccc&quot;]],&quot;deviceIds&quot;:[&quot;root.s1&quot;,&quot;root.s1&quot;,&quot;root.s1&quot;,&quot;root.s3&quot;]}&#39;</span> http://127.0.0.1:18080/rest/v1/insertRecords
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p>响应参数：</p><table><thead><tr><th>参数名称</th><th>参数类型</th><th>参数描述</th></tr></thead><tbody><tr><td>code</td><td>integer</td><td>状态码</td></tr><tr><td>message</td><td>string</td><td>信息提示</td></tr></tbody></table><p>响应示例：</p><div class="language-json line-numbers-mode" data-ext="json"><pre class="language-json"><code><span class="token punctuation">{</span>
  <span class="token property">&quot;code&quot;</span><span class="token operator">:</span> <span class="token number">200</span><span class="token punctuation">,</span>
  <span class="token property">&quot;message&quot;</span><span class="token operator">:</span> <span class="token string">&quot;SUCCESS_STATUS&quot;</span>
<span class="token punctuation">}</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div>`,36);function f(x,j){const e=o("ExternalLinkIcon");return i(),l("div",null,[u(`
...
`),r,s("p",null,[n("请求路径："),s("a",d,[n("http://ip"),t(e)]),n(":port/ping")]),v,s("p",null,[n("请求路径："),s("a",k,[n("http://ip"),t(e)]),n(":port/rest/v1/query")]),m,s("p",null,[n("请求路径："),s("a",b,[n("http://ip"),t(e)]),n(":port/rest/v1/nonQuery")]),q,s("p",null,[n("请求路径："),s("a",g,[n("http://ip"),t(e)]),n(":port/rest/v1/insertTablet")]),h,s("p",null,[n("请求路径："),s("a",y,[n("http://ip"),t(e)]),n(":port/rest/v1/insertRecords")]),T])}const S=p(c,[["render",f],["__file","RestServiceV1.html.vue"]]);export{S as default};
