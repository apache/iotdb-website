...
<span class="token key atrule">inhibit_rules</span><span class="token punctuation">:</span>
  <span class="token punctuation">-</span> <span class="token key atrule">source_match</span><span class="token punctuation">:</span>
    ...
    <span class="token key atrule">target_match</span><span class="token punctuation">:</span>
      <span class="token key atrule">severity</span><span class="token punctuation">:</span> <span class="token string">&#39;warning&#39;</span>
    <span class="token key atrule">equal</span><span class="token punctuation">:</span> <span class="token punctuation">[</span><span class="token string">&#39;alertname&#39;</span><span class="token punctuation">]</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="api" tabindex="-1"><a class="header-anchor" href="#api" aria-hidden="true">#</a> API</h4>`,5),w=s("code",null,"AlertManager",-1),_=s("code",null,"v1",-1),q=s("code",null,"v2",-1),A=s("code",null,"AlertManager",-1),E=s("code",null,"v2",-1),x={href:"https://github.com/prometheus/alertmanager/blob/master/api/v2/openapi.yaml",target:"_blank",rel:"noopener noreferrer"},M=e('<p>默认配置的前缀为 <code>/api/v1</code> 或 <code>/api/v2</code>， 发送告警的 endpoint 为 <code>/api/v1/alerts</code> 或 <code>/api/v2/alerts</code>。 如果用户指定了 <code>--web.route-prefix</code>， 例如 <code>--web.route-prefix=/alertmanager/</code>， 那么前缀将会变为 <code>/alertmanager/api/v1</code> 或 <code>/alertmanager/api/v2</code>， 发送告警的 endpoint 变为 <code>/alertmanager/api/v1/alerts</code> 或 <code>/alertmanager/api/v2/alerts</code>。</p><h3 id="创建-trigger" tabindex="-1"><a class="header-anchor" href="#创建-trigger" aria-hidden="true">#</a> 创建 trigger</h3><h4 id="编写-trigger-类" tabindex="-1"><a class="header-anchor" href="#编写-trigger-类" aria-hidden="true">#</a> 编写 trigger 类</h4>',3),T=s("code",null,"AlertManagerSink",-1),S=e(`<p>下面的示例创建了 <code>org.apache.iotdb.trigger.AlertingExample</code> 类， 其 <code>alertManagerHandler</code> 成员变量可发送告警至地址为 <code>http://127.0.0.1:9093/</code> 的 AlertManager 实例。</p><p>当 <code>value &gt; 100.0</code> 时，发送 <code>severity</code> 为 <code>critical</code> 的告警； 当 <code>50.0 &lt; value &lt;= 100.0</code> 时，发送 <code>severity</code> 为 <code>warning</code> 的告警。</p><div class="language-java line-numbers-mode" data-ext="java"><pre class="language-java"><code><span class="token keyword">package</span> <span class="token namespace">org<span class="token punctuation">.</span>apache<span class="token punctuation">.</span>iotdb<span class="token punctuation">.</span>trigger</span><span class="token punctuation">;</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>执行完上述写入语句后，可以收到告警邮件。由于我们的 <code>AlertManager</code> 配置中设定 <code>severity</code> 为 <code>critical</code> 的告警 会抑制 <code>severity</code> 为 <code>warning</code> 的告警，我们收到的告警邮件中只包含写入 <code>(5, 120)</code> 后触发的告警。</p><img alt="alerting" src="https://alioss.timecho.com/docs/img/github/115957896-a9791080-a537-11eb-9962-541412bdcee6.png">`,11);function I(N,O){const t=p("ExternalLinkIcon"),o=p("RouterLink");return c(),i("div",null,[u(`
...
`),d,s("p",null,[n("预编译好的二进制文件可在 "),s("a",v,[n("这里"),a(t)]),n(" 下载。")]),m,s("p",null,[n("可在 "),s("a",b,[n("Quay.io"),a(t)]),n(" 或 "),s("a",g,[n("Docker Hub"),a(t)]),n(" 获得。")]),h,s("p",null,[n("如下是一个示例，可以覆盖到大部分配置规则，详细的配置规则参见 "),s("a",y,[n("这里"),a(t)]),n("。")]),f,s("p",null,[w,n(" API 分为 "),_,n(" 和 "),q,n(" 两个版本，当前 "),A,n(" API 版本为 "),E,n(" （配置参见 "),s("a",x,[n("api/v2/openapi.yaml"),a(t)]),n(")。")]),M,s("p",null,[n("用户通过自行创建 Java 类、编写钩子中的逻辑来定义一个触发器。 具体配置流程以及 Sink 模块提供的 "),T,n(" 相关工具类的使用方法参见 "),a(o,{to:"/zh/UserGuide/V0.13.x/Process-Data/Triggers.html"},{default:r(()=>[n("Triggers")]),_:1}),n("。")]),S])}const L=l(k,[["render",I],["__file","Alerting.html.vue"]]);export{L as default};