...
`),m,e("p",null,[t("The specified syntax for compression is detailed in "),c(i,{to:"/UserGuide/V0.13.x/Reference/SQL-Reference.html"},{default:d(()=>[t("Create Timeseries Statement")]),_:1}),t(".")]),p,u,f,_])}const w=s(h,[["render",g],["__file","Compression.html.vue"]]);export{w as default};
