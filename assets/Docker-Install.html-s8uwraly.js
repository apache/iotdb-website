...
`),d,s("p",null,[n("Apache IoTDB 的 Docker 镜像已经上传至 "),s("a",u,[n("https://hub.docker.com/r/apache/iotdb"),e(a)]),n("。"),k,n(" Apache IoTDB 的配置项以环境变量形式添加到容器内。")]),v,s("p",null,[n("目前只支持 host 网络和 overlay 网络，不支持 bridge 网络。overlay 网络参照"),s("a",b,[n("1C2D"),e(a)]),n("的写法，host 网络如下。")]),m,s("p",null,[n("内存配置文件为 "),s("a",_,[n("confignode-env.sh"),e(a)]),n(" 和 "),s("a",h,[n("datanode-env.sh"),e(a)]),n("。堆内存 MAX_HEAP_SIZE 和 HEAP_NEWSIZE， 堆外内存 MAX_DIRECT_MEMORY_SIZE。例如："),g]),f])}const S=o(r,[["render",y],["__file","Docker-Install.html.vue"]]);export{S as default};
