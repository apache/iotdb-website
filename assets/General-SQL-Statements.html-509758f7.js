...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><ul><li>删除时间序列</li></ul><p>创建名为 root.ln.wf01.wt01.temperature 的时间序列</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>DELETE TIMESERIES root.ln.wf01.wt01.temperature
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div>`,63);function r(s,u){return a(),t("div",null,[i(`
