...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div>`,57),E=s(`<h3 id="停止-iotdb" tabindex="-1"><a class="header-anchor" href="#停止-iotdb" aria-hidden="true">#</a> 停止 IoTDB</h3><p>用户可以使用$IOTDB_HOME/sbin 文件夹下的 stop-standalone 脚本停止 IoTDB。</p><p>Linux 系统与 MacOS 系统停止命令如下：</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>&gt; sudo bash sbin/stop-standalone.sh
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div>`,11),f=s('<h2 id="基础配置" tabindex="-1"><a class="header-anchor" href="#基础配置" aria-hidden="true">#</a> 基础配置</h2><p>配置文件在&quot;conf&quot;文件夹下，包括：</p><ul><li>环境配置模块 (<code>datanode-env.bat</code>, <code>datanode-env.sh</code>),</li><li>系统配置模块 (<code>iotdb-datanode.properties</code>)</li><li>日志配置模块 (<code>logback.xml</code>).</li></ul>',3);function D(w,B){const a=l("RouterLink"),d=l("ExternalLinkIcon");return o(),c("div",null,[u(`
