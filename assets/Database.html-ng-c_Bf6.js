...
`),v,c("p",null,[e("在 database 创建后，我们可以使用 "),i(a,{to:"/zh/UserGuide/latest/stage/Reference/SQL-Reference.html"},{default:n(()=>[e("SHOW DATABASES")]),_:1}),e(" 语句和 "),i(a,{to:"/zh/UserGuide/latest/stage/Reference/SQL-Reference.html"},{default:n(()=>[e("SHOW DATABASES <PathPattern>")]),_:1}),e(" 来查看 database，SQL 语句如下所示：")]),b])}const A=t(u,[["render",m],["__file","Database.html.vue"]]);export{A as default};
