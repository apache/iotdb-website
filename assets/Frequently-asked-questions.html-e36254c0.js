import{_ as d,C as r,O as o,P as l,ah as t,Q as i,U as e,ai as n,aW as a}from"./framework-5638dcb2.js";const c={},u=a(`<h2 id="常见问题" tabindex="-1"><a class="header-anchor" href="#常见问题" aria-hidden="true">#</a> 常见问题</h2><p><strong>如何查询我的 IoTDB 版本</strong></p><p>有几种方法可以识别您使用的 IoTDB 版本：</p><ul><li>启动 IoTDB 的命令行界面：</li></ul><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>&gt; ./start-cli.sh -p 6667 -pw root -u root -h localhost
...
&gt;   6
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div><p><strong>可以使用 Hadoop 和 Spark 读取 IoTDB 中的 TsFile 吗？</strong></p>`,28),p={href:"https://github.com/apache/iotdb/tree/master/hadoop",target:"_blank",rel:"noopener noreferrer"},v={href:"https://github.com/apache/iotdb/tree/master/spark",target:"_blank",rel:"noopener noreferrer"},m={href:"https://github.com/apache/iotdb/tree/master/grafana",target:"_blank",rel:"noopener noreferrer"},_=a(`<p><strong>IoTDB 如何处理重复的数据点</strong></p><p>一个数据点是由一个完整的时间序列路径（例如：<code>root.vehicle.d0.s0</code>) 和时间戳唯一标识的。如果您使用与现有点相同的路径和时间戳提交一个新点，那么 IoTDB 将更新这个点的值，而不是插入一个新点。</p><p><strong>我如何知道具体的 timeseries 的类型</strong></p><p>在 IoTDB 的命令行接口中使用 SQL <code>SHOW TIMESERIES &lt;timeseries path&gt;</code>:</p><p>例如：如果您想知道所有 timeseries 的类型 &lt;timeseries path&gt; 应该为 <code>root</code>。上面的 SQL 应该修改为：</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>IoTDB&gt; show timeseries root
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div>`,13);function g(b,h){const s=r("ExternalLinkIcon");return o(),l("div",null,[t(`
...
`),t(" TOC "),u,i("p",null,[e("是的。IoTDB 与开源生态紧密结合。IoTDB 支持 "),i("a",p,[e("Hadoop"),n(s)]),e(", "),i("a",v,[e("Spark"),n(s)]),e(" 和 "),i("a",m,[e("Grafana"),n(s)]),e(" 可视化工具。")]),_])}const I=d(c,[["render",g],["__file","Frequently-asked-questions.html.vue"]]);export{I as default};