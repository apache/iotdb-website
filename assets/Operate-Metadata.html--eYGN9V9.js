...
`),v,t("p",null,[e("在 database 创建后，我们可以使用 "),s(n,{to:"/zh/UserGuide/latest/Reference/SQL-Reference.html"},{default:a(()=>[e("SHOW DATABASES")]),_:1}),e(" 语句和 "),s(n,{to:"/zh/UserGuide/latest/Reference/SQL-Reference.html"},{default:a(()=>[e("SHOW DATABASES <PathPattern>")]),_:1}),e(" 来查看 database，SQL 语句如下所示：")]),p,t("p",null,[e("详细的数据类型与编码方式的对应列表请参见 "),s(n,{to:"/zh/UserGuide/latest/Basic-Concept/Encoding.html"},{default:a(()=>[e("编码方式")]),_:1}),e("。")]),m])}const E=l(u,[["render",b],["__file","Operate-Metadata.html.vue"]]);export{E as default};
