...
+-----------------------------+---------------------------------------------------------------------------------------+
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,121),m=s('<h2 id="data-profiling" tabindex="-1"><a class="header-anchor" href="#data-profiling" aria-hidden="true">#</a> Data Profiling</h2><h3 id="acf" tabindex="-1"><a class="header-anchor" href="#acf" aria-hidden="true">#</a> ACF</h3><h4 id="usage-5" tabindex="-1"><a class="header-anchor" href="#usage-5" aria-hidden="true">#</a> Usage</h4>',3),b=e("br",null,null,-1),h=e("br",null,null,-1),T=e("p",null,[e("strong",null,"Name:"),n(" ACF")],-1),g=e("p",null,[e("strong",null,"Input Series:"),n(" Only support a single input numeric series. The type is INT32 / INT64 / FLOAT / DOUBLE.")],-1),f=e("strong",null,"Output Series:",-1),k=e("br",null,null,-1),x=s(`<p><strong>Note:</strong></p><ul><li><code>null</code> and <code>NaN</code> values in the input series will be ignored and treated as 0.</li></ul><h4 id="examples-5" tabindex="-1"><a class="header-anchor" href="#examples-5" aria-hidden="true">#</a> Examples</h4><p>Input series:</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>+-----------------------------+---------------+
|                         Time|root.test.d1.s1|
+-----------------------------+---------------+
...
|2021-03-06T17:00:00.000+08:00|                                                     3.4100000858306885|
+-----------------------------+-----------------------------------------------------------------------+
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="sample" tabindex="-1"><a class="header-anchor" href="#sample" aria-hidden="true">#</a> Sample</h3><h4 id="usage-21" tabindex="-1"><a class="header-anchor" href="#usage-21" aria-hidden="true">#</a> Usage</h4>`,278),w=e("br",null,null,-1),q=e("br",null,null,-1),y=e("br",null,null,-1),O=e("strong",null,"Reservoir sampling",-1),I=e("br",null,null,-1),N=e("br",null,null,-1),S=e("strong",null,"Isometric sampling",-1),L=e("br",null,null,-1),E=e("strong",null,"Triangle sampling",-1),A=e("br",null,null,-1),D=e("br",null,null,-1),U={href:"http://skemman.is/stream/get/1946/15343/37285/3/SS_MSthesis.pdf",target:"_blank",rel:"noopener noreferrer"},B=s(`<p><strong>Name:</strong> SAMPLE</p><p><strong>Input Series:</strong> Only support a single input series. The type is arbitrary.</p><p><strong>Parameters:</strong></p><ul><li><code>method</code>: The method of sampling, which is &#39;reservoir&#39;, &#39;isometric&#39; or &#39;triangle&#39;. By default, reservoir sampling is used.</li><li><code>k</code>: The number of sampling, which is a positive integer. By default, it&#39;s 1.</li></ul><p><strong>Output Series:</strong> Output a single series. The type is the same as the input. The length of the output series is <code>k</code>. Each data point in the output series comes from the input series.</p><p><strong>Note:</strong> If <code>k</code> is greater than the length of input series, all data points in the input series will be output.</p><h4 id="examples-21" tabindex="-1"><a class="header-anchor" href="#examples-21" aria-hidden="true">#</a> Examples</h4><h5 id="reservoir-sampling" tabindex="-1"><a class="header-anchor" href="#reservoir-sampling" aria-hidden="true">#</a> Reservoir Sampling</h5><p>When <code>method</code> is &#39;reservoir&#39; or the default, reservoir sampling is used.<br> Due to the randomness of this method, the output series shown below is only a possible result.</p><p>Input series:</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>+-----------------------------+---------------+
|                         Time|root.test.d1.s1|
+-----------------------------+---------------+
...
+-----------------------------+-----------------------------------------------------+
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,55);function W(P,$){const t=l("RouterLink"),r=l("ExternalLinkIcon");return o(),c("div",null,[i(`
...
`),m,e("p",null,[n("This function is used to calculate the auto-correlation factor of the input time series,"),b,n(" which equals to cross correlation between the same series."),h,n(" For more information, please refer to "),a(t,{to:"/UserGuide/V1.2.x/Reference/Data-Matching.html#XCorr"},{default:d(()=>[n("XCorr")]),_:1}),n(" function.")]),T,g,e("p",null,[f,n(" Output a single series. The type is DOUBLE."),k,n(" There are $2N-1$ data points in the series, and the values are interpreted in details in "),a(t,{to:"/UserGuide/V1.2.x/Reference/Data-Matching.html#XCorr"},{default:d(()=>[n("XCorr")]),_:1}),n(" function.")]),x,e("p",null,[n("This function is used to sample the input series,"),w,n(" that is, select a specified number of data points from the input series and output them."),q,n(" Currently, three sampling methods are supported:"),y,O,n(" randomly selects data points."),I,n(" All of the points have the same probability of being sampled."),N,S,n(" selects data points at equal index intervals."),L,E,n(" assigns data points to the buckets based on the number of sampling."),A,n(" Then it calculates the area of the triangle based on these points inside the bucket and selects the point with the largest area of the triangle."),D,n(" For more detail, please read "),e("a",U,[n("paper"),a(r)])]),B,i(`
...
`),R])}const V=u(v,[["render",W],["__file","UDF-Libraries.html.vue"]]);export{V as default};
