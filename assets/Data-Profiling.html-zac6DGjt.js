import{_ as r,r as l,o as u,c as o,a as c,d as e,e as n,b as s,w as d,f as i}from"./app-QUK6SVpf.js";const v={},p=i('<h1 id="data-profiling" tabindex="-1"><a class="header-anchor" href="#data-profiling" aria-hidden="true">#</a> Data Profiling</h1><h2 id="acf" tabindex="-1"><a class="header-anchor" href="#acf" aria-hidden="true">#</a> ACF</h2><h3 id="usage" tabindex="-1"><a class="header-anchor" href="#usage" aria-hidden="true">#</a> Usage</h3>',3),m=e("br",null,null,-1),b=e("br",null,null,-1),h=e("p",null,[e("strong",null,"Name:"),n(" ACF")],-1),T=e("p",null,[e("strong",null,"Input Series:"),n(" Only support a single input numeric series. The type is INT32 / INT64 / FLOAT / DOUBLE.")],-1),g=e("strong",null,"Output Series:",-1),x=e("br",null,null,-1),k=i(`<p><strong>Note:</strong></p><ul><li><code>null</code> and <code>NaN</code> values in the input series will be ignored and treated as 0.</li></ul><h3 id="examples" tabindex="-1"><a class="header-anchor" href="#examples" aria-hidden="true">#</a> Examples</h3><p>Input series:</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>+-----------------------------+---------------+
...
|2021-03-06T17:00:00.000+08:00|                                                     3.4100000858306885|
+-----------------------------+-----------------------------------------------------------------------+
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="sample" tabindex="-1"><a class="header-anchor" href="#sample" aria-hidden="true">#</a> Sample</h2><h3 id="usage-16" tabindex="-1"><a class="header-anchor" href="#usage-16" aria-hidden="true">#</a> Usage</h3>`,278),f=e("br",null,null,-1),q=e("br",null,null,-1),y=e("br",null,null,-1),w=e("strong",null,"Reservoir sampling",-1),O=e("br",null,null,-1),N=e("br",null,null,-1),I=e("strong",null,"Isometric sampling",-1),L=e("br",null,null,-1),S=e("strong",null,"Triangle sampling",-1),E=e("br",null,null,-1),D=e("br",null,null,-1),A={href:"http://skemman.is/stream/get/1946/15343/37285/3/SS_MSthesis.pdf",target:"_blank",rel:"noopener noreferrer"},U=i(`<p><strong>Name:</strong> SAMPLE</p><p><strong>Input Series:</strong> Only support a single input series. The type is arbitrary.</p><p><strong>Parameters:</strong></p><ul><li><code>method</code>: The method of sampling, which is &#39;reservoir&#39;, &#39;isometric&#39; or &#39;triangle&#39;. By default, reservoir sampling is used.</li><li><code>k</code>: The number of sampling, which is a positive integer. By default, it&#39;s 1.</li></ul><p><strong>Output Series:</strong> Output a single series. The type is the same as the input. The length of the output series is <code>k</code>. Each data point in the output series comes from the input series.</p><p><strong>Note:</strong> If <code>k</code> is greater than the length of input series, all data points in the input series will be output.</p><h3 id="examples-16" tabindex="-1"><a class="header-anchor" href="#examples-16" aria-hidden="true">#</a> Examples</h3><h4 id="reservoir-sampling" tabindex="-1"><a class="header-anchor" href="#reservoir-sampling" aria-hidden="true">#</a> Reservoir Sampling</h4><p>When <code>method</code> is &#39;reservoir&#39; or the default, reservoir sampling is used.<br> Due to the randomness of this method, the output series shown below is only a possible result.</p><p>Input series:</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>+-----------------------------+---------------+
|                         Time|root.test.d1.s1|
+-----------------------------+---------------+
...
+-----------------------------+--------------------+
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,110);function _(B,M){const a=l("RouterLink"),t=l("ExternalLinkIcon");return u(),o("div",null,[c(`
...
`),p,e("p",null,[n("This function is used to calculate the auto-correlation factor of the input time series,"),m,n(" which equals to cross correlation between the same series."),b,n(" For more information, please refer to "),s(a,{to:"/UserGuide/latest/stage/Operators-Functions/Data-Matching.html#XCorr"},{default:d(()=>[n("XCorr")]),_:1}),n(" function.")]),h,T,e("p",null,[g,n(" Output a single series. The type is DOUBLE."),x,n(" There are $2N-1$ data points in the series, and the values are interpreted in details in "),s(a,{to:"/UserGuide/latest/stage/Operators-Functions/Data-Matching.html#XCorr"},{default:d(()=>[n("XCorr")]),_:1}),n(" function.")]),k,e("p",null,[n("This function is used to sample the input series,"),f,n(" that is, select a specified number of data points from the input series and output them."),q,n(" Currently, three sampling methods are supported:"),y,w,n(" randomly selects data points."),O,n(" All of the points have the same probability of being sampled."),N,I,n(" selects data points at equal index intervals."),L,S,n(" assigns data points to the buckets based on the number of sampling."),E,n(" Then it calculates the area of the triangle based on these points inside the bucket and selects the point with the largest area of the triangle."),D,n(" For more detail, please read "),e("a",A,[n("paper"),s(t)])]),U])}const Q=r(v,[["render",_],["__file","Data-Profiling.html.vue"]]);export{Q as default};
