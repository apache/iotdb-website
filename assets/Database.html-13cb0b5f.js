...
`),h,l("p",null,[e("After creating the database, we can use the "),t(a,{to:"/UserGuide/V1.2.x/Reference/SQL-Reference.html"},{default:n(()=>[e("SHOW DATABASES")]),_:1}),e(" statement and "),t(a,{to:"/UserGuide/V1.2.x/Reference/SQL-Reference.html"},{default:n(()=>[e("SHOW DATABASES <PathPattern>")]),_:1}),e(" to view the databases. The SQL statements are as follows:")]),b])}const T=i(u,[["render",m],["__file","Database.html.vue"]]);export{T as default};
