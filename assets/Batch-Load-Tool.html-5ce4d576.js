import{_ as a,E as s,F as r,af as c,G as n,I as e,ag as o,ac as i,C as l}from"./framework-6055ecdb.js";const d={},h=n("h1",{id:"批量数据导入",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#批量数据导入","aria-hidden":"true"},"#"),e(" 批量数据导入")],-1),u=n("p",null,"针对于不同场景，IoTDB 为用户提供多种批量导入数据的操作方式，本章节向大家介绍最为常用的两种方式为 CSV文本形式的导入 和 TsFile文件形式的导入。",-1),T=n("h2",{id:"tsfile批量导入",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#tsfile批量导入","aria-hidden":"true"},"#"),e(" TsFile批量导入")],-1),f=n("h2",{id:"csv批量导入",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#csv批量导入","aria-hidden":"true"},"#"),e(" CSV批量导入")],-1);function p(_,m){const t=l("RouterLink");return s(),r("div",null,[c(`
