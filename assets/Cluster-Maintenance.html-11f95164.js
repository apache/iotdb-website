import{_ as s,r as d,o as l,c as a,a as o,d as t,e,b as r,w as v,f as n}from"./app-62e84e56.js";const u={},c=n(`<h2 id="集群运维命令" tabindex="-1"><a class="header-anchor" href="#集群运维命令" aria-hidden="true">#</a> 集群运维命令</h2><h3 id="展示集群配置" tabindex="-1"><a class="header-anchor" href="#展示集群配置" aria-hidden="true">#</a> 展示集群配置</h3><p>当前 IoTDB 支持使用如下 SQL 展示集群的关键参数：</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>SHOW VARIABLES
...
Total line number = 4
It costs 0.165s
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="region-状态定义" tabindex="-1"><a class="header-anchor" href="#region-状态定义" aria-hidden="true">#</a> Region 状态定义</h4><p>Region 继承所在 DataNode 的状态，对 Region 各状态定义如下：</p><ul><li><strong>Running</strong>: Region 所在 DataNode 正常运行，Region 可读可写</li><li><strong>Unknown</strong>: Region 所在 DataNode 未正常上报心跳，ConfigNode 认为该 Region 不可读写</li><li><strong>Removing</strong>: Region 所在 DataNode 正在被移出集群，Region 不可读写</li><li><strong>ReadOnly</strong>: Region 所在 DataNode 的磁盘剩余空间低于 disk_warning_threshold（默认 5%），Region 可读，但不能写入，不能同步数据</li></ul><p><strong>单个 Region 的状态切换不会影响所属 RegionGroup 的运行</strong>，<br> 在设置多副本集群时（即元数据副本数和数据副本数大于 1），<br> 同 RegionGroup 其它 Running 状态的 Region 能保证该 RegionGroup 的高可用性。</p><p><strong>对于一个 RegionGroup：</strong></p><ul><li>当且仅当严格多于一半的 Region 处于 Running 状态时， 该 RegionGroup 可进行数据的查询、写入和删除操作</li><li>如果处于 Running 状态的 Region 少于一半，该 RegionGroup 不可进行数据的数据的查询、写入和删除操作</li></ul><h3 id="展示集群槽信息" tabindex="-1"><a class="header-anchor" href="#展示集群槽信息" aria-hidden="true">#</a> 展示集群槽信息</h3><p>集群使用分区来管理元数据和数据，分区定义如下：</p><ul><li><strong>元数据分区</strong>：SeriesSlot</li><li><strong>数据分区</strong>：&lt;SeriesSlot，SeriesTimeSlot&gt;</li></ul>`,64),g=n(`<p>可以使用以下 SQL 来查询分区对应信息：</p><h4 id="展示数据分区所在的-dataregion" tabindex="-1"><a class="header-anchor" href="#展示数据分区所在的-dataregion" aria-hidden="true">#</a> 展示数据分区所在的 DataRegion</h4><p>展示一个数据分区（或一个序列槽下的所有数据分区）所在的 DataRegion:</p><ul><li><code>SHOW DATA REGIONID OF root.sg WHERE SERIESSLOTID=s0 (AND TIMESLOTID=t0)</code></li></ul><p>有如下几点说明：</p><ol><li><p>s0、t0均只能为数字。</p></li><li><p>TimeSlotId 是 SeriesTimeSlotId 的简称。</p></li><li><p>”SERIESSLOTID=s0”可以被替换为”DEVICEID=xxx.xx.xx“。 这样的话，sql会自动计算对应该设备id的序列槽。</p></li><li><p>同样的，&quot;TIMESLOTID=t0&quot;也可以被替换为&quot;TIMESTAMP=t1&quot;。这样，SQL会计算该时间戳对应的时间槽，也就是时间段包含该时间戳的时间槽。</p></li></ol><p>示例:</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>IoTDB&gt; show data regionid of root.sg where seriesslotid=5286 and timeslotid=0
+--------+
|RegionId|
+--------+
|       1|
...
Total line number = 2
It costs 0.006s
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="展示元数据分区所在的-schemaregion" tabindex="-1"><a class="header-anchor" href="#展示元数据分区所在的-schemaregion" aria-hidden="true">#</a> 展示元数据分区所在的 SchemaRegion</h4><p>展示一个元数据分区所在的 SchemaRegion：</p><ul><li><code>SHOW SCHEMA REGIONID OF root.sg WHERE SERIESSLOTID=s0</code></li></ul><p>同样的，”SERIESSLOTID“与”TIMESLOTID“依然是可替换的。</p><p>示例:</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>IoTDB&gt; show schema regionid of root.sg where seriesslotid=5286
+--------+
|RegionId|
+--------+
|       0|
...
Total line number = 1
It costs 0.007s
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="展示序列槽下的时间槽" tabindex="-1"><a class="header-anchor" href="#展示序列槽下的时间槽" aria-hidden="true">#</a> 展示序列槽下的时间槽</h4><p>展示一个序列槽下的所有时间槽：</p><ul><li><code>SHOW TIMESLOTID OF root.sg WHERE SERIESLOTID=s0 (AND STARTTIME=t1) (AND ENDTIME=t2)</code></li></ul><p>示例:</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>IoTDB&gt; show timeslotid of root.sg where seriesslotid=5286
+----------+
|TimeSlotId|
+----------+
|         0|
...
Total line number = 18
It costs 0.165s
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,29);function m(b,R){const i=d("RouterLink");return l(),a("div",null,[o(`
...
`),c,t("p",null,[e("在文档"),r(i,{to:"/zh/UserGuide/V1.1.x/Cluster/Cluster-Concept.html"},{default:v(()=>[e("Cluster-Concept")]),_:1}),e("中可以查看详细信息。")]),g])}const p=s(u,[["render",m],["__file","Cluster-Maintenance.html.vue"]]);export{p as default};
