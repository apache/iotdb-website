import{_ as n,O as s,P as e,ah as a,aW as l}from"./framework-5609642f.js";const t={},i=l(`<h1 id="查询结果分页" tabindex="-1"><a class="header-anchor" href="#查询结果分页" aria-hidden="true">#</a> 查询结果分页</h1><p>当查询结果集数据量很大，放在一个页面不利于显示，可以使用 <code>LIMIT/SLIMIT</code> 子句和 <code>OFFSET/SOFFSET </code>子句进行分页控制。</p><ul><li><code>LIMIT</code> 和 <code>SLIMIT</code> 子句用于控制查询结果的行数和列数。</li><li><code>OFFSET</code> 和 <code>SOFFSET</code> 子句用于控制结果显示的起始位置。</li></ul><h2 id="按行分页" tabindex="-1"><a class="header-anchor" href="#按行分页" aria-hidden="true">#</a> 按行分页</h2><p>用户可以通过 <code>LIMIT</code> 和 <code>OFFSET</code> 子句控制查询结果的行数，<code>LIMIT rowLimit</code> 指定查询结果的行数，<code>OFFSET rowOffset</code> 指定查询结果显示的起始行位置。</p><p>注意：</p><ul><li>当 <code>rowOffset</code> 超过结果集的大小时，返回空结果集。</li><li>当 <code>rowLimit</code> 超过结果集的大小时，返回所有查询结果。</li><li>当 <code>rowLimit</code> 和 <code>rowOffset</code> 不是正整数，或超过 <code>INT32</code> 允许的最大值时，系统将提示错误。</li></ul><p>我们将通过以下示例演示如何使用 <code>LIMIT</code> 和 <code>OFFSET</code> 子句。</p><ul><li><strong>示例 1：</strong> 基本的 <code>LIMIT</code> 子句</li></ul><p>SQL 语句：</p><div class="language-sql line-numbers-mode" data-ext="sql"><pre class="language-sql"><code><span class="token keyword">select</span> <span class="token keyword">status</span><span class="token punctuation">,</span> temperature <span class="token keyword">from</span> root<span class="token punctuation">.</span>ln<span class="token punctuation">.</span>wf01<span class="token punctuation">.</span>wt01 <span class="token keyword">limit</span> <span class="token number">10</span>
...
Total line number = 4
It costs 0.016s
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="按列分页" tabindex="-1"><a class="header-anchor" href="#按列分页" aria-hidden="true">#</a> 按列分页</h2><p>用户可以通过 <code>SLIMIT</code> 和 <code>SOFFSET</code> 子句控制查询结果的列数，<code>SLIMIT seriesLimit</code> 指定查询结果的列数，<code>SOFFSET seriesOffset</code> 指定查询结果显示的起始列位置。</p><p>注意：</p><ul><li>仅用于控制值列，对时间列和设备列无效。</li><li>当 <code>seriesOffset</code> 超过结果集的大小时，返回空结果集。</li><li>当 <code>seriesLimit</code> 超过结果集的大小时，返回所有查询结果。</li><li>当 <code>seriesLimit</code> 和 <code>seriesOffset</code> 不是正整数，或超过 <code>INT32</code> 允许的最大值时，系统将提示错误。</li></ul><p>我们将通过以下示例演示如何使用 <code>SLIMIT</code> 和 <code>SOFFSET</code> 子句。</p><ul><li><strong>示例 1：</strong> 基本的 <code>SLIMIT</code> 子句</li></ul><p>SQL 语句：</p><div class="language-sql line-numbers-mode" data-ext="sql"><pre class="language-sql"><code><span class="token keyword">select</span> <span class="token operator">*</span> <span class="token keyword">from</span> root<span class="token punctuation">.</span>ln<span class="token punctuation">.</span>wf01<span class="token punctuation">.</span>wt01 <span class="token keyword">where</span> <span class="token keyword">time</span> <span class="token operator">&gt;</span> <span class="token number">2017</span><span class="token operator">-</span><span class="token number">11</span><span class="token operator">-</span><span class="token number">01</span>T00:<span class="token number">05</span>:<span class="token number">00.000</span> <span class="token operator">and</span> <span class="token keyword">time</span> <span class="token operator">&lt;</span> <span class="token number">2017</span><span class="token operator">-</span><span class="token number">11</span><span class="token operator">-</span><span class="token number">01</span>T00:<span class="token number">12</span>:<span class="token number">00.000</span> slimit <span class="token number">1</span>
