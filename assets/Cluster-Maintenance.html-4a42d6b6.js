...
Total line number = 4
It costs 0.165s
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="region-status-definition" tabindex="-1"><a class="header-anchor" href="#region-status-definition" aria-hidden="true">#</a> Region status definition</h3><p>Region inherits the status of the DataNode where the Region resides. And Region states are defined as follows:</p><ul><li><strong>Running</strong>: The DataNode where the Region resides is running properly, the Region is readable and writable.</li><li><strong>Unknown</strong>: The DataNode where the Region resides doesn&#39;t report heartbeat properly, the ConfigNode considers the Region is unreadable and un-writable.</li><li><strong>Removing</strong>: The DataNode where the Region resides is being removed from the cluster, the Region is unreadable and un-writable.</li><li><strong>ReadOnly</strong>: The available disk space of the DataNode where the Region resides is lower than the disk_warning_threshold(5% by default). The Region is readable but un-writable and cannot synchronize data.</li></ul><p><strong>The status switchover of a Region doesn&#39;t affect the belonged RegionGroup</strong>, when setting up a multi-replica cluster(i.e. the number of schema replica and data replica is greater than 1), other Running Regions of the same RegionGroup ensure the high availability of RegionGroup.</p><p><strong>For a RegionGroup:</strong></p><ul><li>It&#39;s readable, writable and deletable if and only if more than half of its Regions are Running</li><li>It&#39;s unreadable, un-writable and un-deletable when the number of its Running Regions is less than half</li></ul><h2 id="show-cluster-slots-information" tabindex="-1"><a class="header-anchor" href="#show-cluster-slots-information" aria-hidden="true">#</a> Show cluster slots information</h2><p>The cluster uses partitions for schema and data arrangement, the partition defined as follows:</p><ul><li><code>SchemaPartition</code>: SeriesSlot</li><li><code>DataPartition</code>: &lt;SeriesSlot, SeriesTimeSlot&gt;</li></ul>`,64),m=n(`<p>The cluster slots information can be shown by the following SQLs:</p><h3 id="show-the-dataregion-where-a-datapartition-resides-in" tabindex="-1"><a class="header-anchor" href="#show-the-dataregion-where-a-datapartition-resides-in" aria-hidden="true">#</a> Show the DataRegion where a DataPartition resides in</h3><p>Show the DataRegion where a DataPartition of a certain database or device resides in:</p><ul><li><code>SHOW DATA REGIONID WHERE (DATABASE=root.xxx |DEVICE=root.xxx.xxx) (AND TIME=xxxxx)?</code></li></ul><p>Specifications:</p><ol><li><p>&quot;DEVICE&quot; corresponds to a unique SeriesSlot for the device path, while &quot;TIME&quot; corresponds to a unique SeriesTimeSlot for either a timestamp or a universal time.</p></li><li><p>&quot;DATABASE&quot; and &quot;DEVICE&quot; must begin with &quot;root&quot;. If the path does not exist, it will return empty instead of reporting an error, as will be seen below.</p></li><li><p>Currently, &quot;DATABASE&quot; and &quot;DEVICE&quot; do not support wildcard matching or multiple queries. If it contains a wildcard character(such as * or **) or multiple DATABASE and DEVICE, an error will be reported, as will be seen below.</p></li><li><p>&quot;TIME&quot; supports both timestamps and universal dates. For timestamp, it must be greater than or equal to 0. For universal time, it need to be no earlier than 1970-01-01 00:00:00.</p></li></ol><p>Eg:</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>IoTDB&gt; show data regionid where device=root.sg.m1.d1
+--------+
|RegionId|
+--------+
|       1|
...
Total line number = 1
It costs 0.006s
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="show-the-schemaregion-where-a-schemapartition-resides-in" tabindex="-1"><a class="header-anchor" href="#show-the-schemaregion-where-a-schemapartition-resides-in" aria-hidden="true">#</a> Show the SchemaRegion where a SchemaPartition resides in</h3><p>Show the SchemaRegion where a DataPartition of a certain database or device resides in:</p><ul><li><code>SHOW SCHEMA REGIONID WHERE (DATABASE=root.xxx | DEVICE=root.xxx.xxx)</code></li></ul><p>Eg:</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>IoTDB&gt; show schema regionid where device=root.sg.m1.d2
+--------+
|RegionId|
+--------+
|       0|
...
Total line number = 1
It costs 0.006s
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="show-the-time-partition-under-filtering-conditions" tabindex="-1"><a class="header-anchor" href="#show-the-time-partition-under-filtering-conditions" aria-hidden="true">#</a> Show the time partition under filtering conditions.</h3><p>Show the TimePartition of a certain device, database, or DataRegion.</p><ul><li><code>SHOW TIMEPARTITION WHERE (DEVICE=root.a.b |REGIONID = r0 | DATABASE=root.xxx) (AND STARTTIME=t1)?(AND ENDTIME=t2)?</code></li></ul><p>Specifications:</p><ol><li>TimePartition is short for SeriesTimeSlotId.</li><li>If REGIONID is the Id of schemaRegion, return empty instead of reporting an error.</li><li>REGIONID do not support multiple queries. If it contains multiple REGIONID, an error will be reported, as will be seen below.</li><li>&quot;STARTTIME&quot; and &quot;ENDTIME&quot; support both timestamps and universal dates. For timestamp, it must be greater than or equal to 0. For universal time, it need to be no earlier than 1970-01-01 00:00:00.</li><li>The StartTime in the returned result is the starting time of the TimePartition&#39;s corresponding time interval.</li></ol><p>Eg:</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>IoTDB&gt; show timePartition where device=root.sg.m1.d1
+-------------------------------------+
...
Total line number = 2
It costs 0.007s
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="count-the-time-partition-under-filtering-conditions" tabindex="-1"><a class="header-anchor" href="#count-the-time-partition-under-filtering-conditions" aria-hidden="true">#</a> Count the time partition under filtering conditions.</h4><p>Count the TimePartition of a certain device, database, or DataRegion.</p><ul><li><code>COUNT TIMEPARTITION WHERE (DEVICE=root.a.b |REGIONID = r0 | DATABASE=root.xxx) (AND STARTTIME=t1)?(AND ENDTIME=t2)?</code></li></ul><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>IoTDB&gt; count timePartition where device=root.sg.m1.d1
+--------------------+
|count(timePartition)|
+--------------------+
|                   1|
...
Total line number = 18
It costs 0.165s
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,34);function g(b,h){const i=a("RouterLink");return d(),t("div",null,[l(`
...
`),c,o("p",null,[e("More details can be found in the "),r(i,{to:"/UserGuide/V1.2.x/Cluster/Cluster-Concept.html"},{default:u(()=>[e("Cluster-Concept")]),_:1}),e(" document.")]),m])}const p=s(v,[["render",g],["__file","Cluster-Maintenance.html.vue"]]);export{p as default};