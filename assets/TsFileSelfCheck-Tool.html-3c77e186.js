import{_ as e,E as a,F as n,af as s,aT as i}from"./framework-4edf7e71.js";const t={},l=i(`<h2 id="tsfile-自检工具" tabindex="-1"><a class="header-anchor" href="#tsfile-自检工具" aria-hidden="true">#</a> TsFile 自检工具</h2><p>IoTDB Server 提供了 TsFile 自检工具，目前该工具可以检查 TsFile 文件中的基本格式、TimeseriesMetadata 的正确性以及 TsFile 中各部分存储的 Statistics 的正确性和一致性。</p><h3 id="使用" tabindex="-1"><a class="header-anchor" href="#使用" aria-hidden="true">#</a> 使用</h3><p>第一步：创建一个 TsFileSelfCheckTool 类的对象。</p><div class="language-java line-numbers-mode" data-ext="java"><pre class="language-java"><code><span class="token class-name">TsFileSelfCheckTool</span> tool <span class="token operator">=</span> <span class="token keyword">new</span> <span class="token class-name">TsFileSelfCheckTool</span><span class="token punctuation">(</span><span class="token punctuation">)</span><span class="token punctuation">;</span>
...
`),l])}const d=e(t,[["render",o],["__file","TsFileSelfCheck-Tool.html.vue"]]);export{d as default};