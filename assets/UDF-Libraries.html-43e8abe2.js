...
|2021-03-06T17:00:00.000+08:00|                                                     3.4100000858306885|
+-----------------------------+-----------------------------------------------------------------------+
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="sample" tabindex="-1"><a class="header-anchor" href="#sample" aria-hidden="true">#</a> Sample</h3><h4 id="函数简介-21" tabindex="-1"><a class="header-anchor" href="#函数简介-21" aria-hidden="true">#</a> 函数简介</h4>`,103),Q=s("strong",null,"蓄水池采样法 (reservoir sampling)",-1),R=s("strong",null,"等距采样法 (isometric sampling)",-1),C=s("strong",null,"最大三角采样法 (triangle sampling)",-1),z={href:"http://skemman.is/stream/get/1946/15343/37285/3/SS_MSthesis.pdf",target:"_blank",rel:"noopener noreferrer"},W=e(`<p><strong>函数名：</strong> SAMPLE</p><p><strong>输入序列：</strong> 仅支持单个输入序列，类型可以是任意的。</p><p><strong>参数：</strong></p><ul><li><code>method</code>：采样方法，取值为 &#39;reservoir&#39;，&#39;isometric&#39; 或 &#39;triangle&#39; 。在缺省情况下，采用蓄水池采样法。</li><li><code>k</code>：采样数，它是一个正整数，在缺省情况下为 1。</li></ul><p><strong>输出序列：</strong> 输出单个序列，类型与输入序列相同。该序列的长度为采样数，序列中的每一个数据点都来自于输入序列。</p><p><strong>提示：</strong> 如果采样数大于序列长度，那么输入序列中所有的数据点都会被输出。</p><h4 id="使用示例-21" tabindex="-1"><a class="header-anchor" href="#使用示例-21" aria-hidden="true">#</a> 使用示例</h4><h5 id="蓄水池采样" tabindex="-1"><a class="header-anchor" href="#蓄水池采样" aria-hidden="true">#</a> 蓄水池采样</h5><p>当<code>method</code>参数为 &#39;reservoir&#39; 或缺省时，采用蓄水池采样法对输入序列进行采样。由于该采样方法具有随机性，下面展示的输出序列只是一种可能的结果。</p><p>输入序列：</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>+-----------------------------+---------------+
|                         Time|root.test.d1.s1|
+-----------------------------+---------------+
...
+-----------------------------+-----------------------------------------------------+
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,55);function u0(p0,v0){const l=d("RouterLink"),r=d("ExternalLinkIcon");return m(),o("div",null,[a(`
...
`),v,s("p",null,[n("本函数用于计算时间序列的自相关函数值，即序列与自身之间的互相关函数，详情参见"),i(l,{to:"/zh/UserGuide/Master/Reference/Data-Matching.html#XCorr"},{default:t(()=>[n("XCorr")]),_:1}),n("函数文档。")]),b,h,s("p",null,[g,n(" 输出单个序列，类型为 DOUBLE。序列中共包含"),T,n("个数据点，每个值的具体含义参见"),i(l,{to:"/zh/UserGuide/Master/Reference/Data-Matching.html#XCorr"},{default:t(()=>[n("XCorr")]),_:1}),n("函数文档。")]),k,x,y,q,f,w,L,N,S,I,E,O,A,_,D,M,B,F,U,s("p",null,[n("本函数对输入序列进行采样，即从输入序列中选取指定数量的数据点并输出。目前，本函数支持三种采样方法："),Q,n(" 对数据进行随机采样，所有数据点被采样的概率相同；"),R,n(" 按照相等的索引间隔对数据进行采样，"),C,n(" 对所有数据会按采样率分桶，每个桶内会计算数据点间三角形面积，并保留面积最大的点，该算法通常用于数据的可视化展示中，采用过程可以保证一些关键的突变点在采用中得到保留，更多抽样算法细节可以阅读论文 "),s("a",z,[n("here"),i(r)]),n("。")]),W,a(`
...
`),o0])}const h0=c(u,[["render",u0],["__file","UDF-Libraries.html.vue"]]);export{h0 as default};
