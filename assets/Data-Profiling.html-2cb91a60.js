...
`),v,s("p",null,[n("本函数用于计算时间序列的自相关函数值，即序列与自身之间的互相关函数，详情参见"),a(i,{to:"/zh/UserGuide/V1.0.x/Operators-Functions/Data-Matching.html#XCorr"},{default:l(()=>[n("XCorr")]),_:1}),n("函数文档。")]),o,b,s("p",null,[h,n(" 输出单个序列，类型为 DOUBLE。序列中共包含"),g,n("个数据点，每个值的具体含义参见"),a(i,{to:"/zh/UserGuide/V1.0.x/Operators-Functions/Data-Matching.html#XCorr"},{default:l(()=>[n("XCorr")]),_:1}),n("函数文档。")]),T,k,x,y,q,f,w,L,N,_,O,I,M,E,S,D,A,B,U,s("p",null,[n("本函数对输入序列进行采样，即从输入序列中选取指定数量的数据点并输出。目前，本函数支持三种采样方法："),F,n(" 对数据进行随机采样，所有数据点被采样的概率相同；"),Q,n(" 按照相等的索引间隔对数据进行采样，"),z,n(" 对所有数据会按采样率分桶，每个桶内会计算数据点间三角形面积，并保留面积最大的点，该算法通常用于数据的可视化展示中，采用过程可以保证一些关键的突变点在采用中得到保留，更多抽样算法细节可以阅读论文 "),s("a",C,[n("here"),a(t)]),n("。")]),H])}const G=r(u,[["render",R],["__file","Data-Profiling.html.vue"]]);export{G as default};
