...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div><p>The SHOW ALL TTL example gives the TTL for all storage groups.<br> The SHOW TTL ON root.group1 , root.group2 , root.group3 example shows the TTL for the three storage<br> groups specified.<br> Note: the TTL for storage groups that do not have a TTL set will display as null.</p>`,14);function r(l,d){return t(),a("div",null,[n(`
