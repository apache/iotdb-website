...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p>注意：目前，要使用单机模式，你需要保证所有的地址设置为 127.0.0.1，如果需要从非 IoTDB 所在的机器访问此IoTDB，请将配置项 <code>dn_rpc_address</code> 修改为 IoTDB 所在的机器 IP。副本数设置为1。并且，推荐使用 IoTConsensus，因为这会带来额外的效率。这些现在都是默认配置。</p><h3 id="使用-cli-工具" tabindex="-1"><a class="header-anchor" href="#使用-cli-工具" aria-hidden="true">#</a> 使用 Cli 工具</h3><p>IoTDB 为用户提供多种与服务器交互的方式，在此我们介绍使用 Cli 工具进行写入、查询数据的基本步骤。</p><p>初始安装后的 IoTDB 中有一个默认用户：root，默认密码为 root。用户可以使用该用户运行 Cli 工具操作 IoTDB。Cli 工具启动脚本为 sbin 文件夹下的 start-cli 脚本。启动脚本时需要指定运行 ip、port、username 和 password。若脚本未给定对应参数，则默认参数为&quot;-h 127.0.0.1 -p 6667 -u root -pw -root&quot;</p><p>以下启动语句为服务器在本机运行，且用户未更改运行端口号的示例。</p><p>Linux 系统与 MacOS 系统启动命令如下：</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>&gt; bash sbin/start-cli.sh -h 127.0.0.1 -p 6667 -u root -pw root
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div>`,57),E=d(`<h3 id="停止-iotdb" tabindex="-1"><a class="header-anchor" href="#停止-iotdb" aria-hidden="true">#</a> 停止 IoTDB</h3><p>用户可以使用$IOTDB_HOME/sbin 文件夹下的 stop-standalone 脚本停止 IoTDB。</p><p>Linux 系统与 MacOS 系统停止命令如下：</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>&gt; sudo bash sbin/stop-standalone.sh
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div>`,11),f=d('<h2 id="基础配置" tabindex="-1"><a class="header-anchor" href="#基础配置" aria-hidden="true">#</a> 基础配置</h2><p>配置文件在&quot;conf&quot;文件夹下，包括：</p><ul><li>环境配置模块 (<code>datanode-env.bat</code>, <code>datanode-env.sh</code>,<code>confignode-env.bat</code>,<code>confignode-env.sh</code>),</li><li>系统配置模块 (<code>iotdb-datanode.properties</code>,<code>iotdb-common.properties</code>,<code>iotdb-confingnode.properties</code>,<code>iotdb-datanode.properties</code>,<code>iotdb-cluster.properties</code>)</li><li>日志配置模块 (<code>logback.xml</code>).</li></ul>',3);function D(w,B){const a=l("RouterLink"),s=l("ExternalLinkIcon");return o(),c("div",null,[u(`
...
`),p,e("p",null,[n("本文将介绍关于 IoTDB 使用的基本流程，如果需要更多信息，请浏览我们官网的 "),i(a,{to:"/zh/UserGuide/Master/IoTDB-Introduction/What-is-IoTDB.html"},{default:t(()=>[n("指引")]),_:1}),n(".")]),m,b,h,g,x,e("ul",null,[_,e("li",null,[e("p",null,[n("二进制可运行程序：请从 "),e("a",T,[n("下载"),i(s)]),n(" 页面下载最新的安装包，解压后即完成安装。")])]),e("li",null,[e("p",null,[n("使用 Docker 镜像：dockerfile 文件位于"),e("a",I,[n("github"),i(s)])])])]),S,e("p",null,[n("想要浏览更多 IoTDB 数据库支持的命令，请浏览 "),i(a,{to:"/zh/UserGuide/Master/SQL-Manual/SQL-Manual.html"},{default:t(()=>[n("SQL Reference")]),_:1}),n("。")]),E,e("p",null,[n("权限管理的具体内容可以参考："),i(a,{to:"/zh/UserGuide/Master/User-Manual/Authority-Management.html"},{default:t(()=>[n("权限管理")]),_:1})]),f])}const L=r(v,[["render",D],["__file","QuickStart.html.vue"]]);export{L as default};
