...
+-----------------------------+--------------------+
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,110);function G(K,X){const i=t("RouterLink"),r=t("ExternalLinkIcon");return c(),m("div",null,[u(`
...
`),o,s("p",null,[e("This function is used to calculate the auto-correlation factor of the input time series, which equals to cross correlation between the same series. For more information, please refer to "),a(i,{to:"/UserGuide/V1.0.x/Operators-Functions/Data-Matching.html#XCorr"},{default:l(()=>[e("XCorr")]),_:1}),e(" function.")]),v,h,s("p",null,[b,e(" Output a single series. The type is DOUBLE. There are "),g,e(" data points in the series, and the values are interpreted in details in "),a(i,{to:"/UserGuide/V1.0.x/Operators-Functions/Data-Matching.html#XCorr"},{default:l(()=>[e("XCorr")]),_:1}),e(" function.")]),T,y,x,k,f,q,w,O,N,L,I,S,M,_,E,D,A,U,B,F,Q,z,C,s("p",null,[e("This function is used to sample the input series, that is, select a specified number of data points from the input series and output them. Currently, three sampling methods are supported: "),P,e(" randomly selects data points. All of the points have the same probability of being sampled. "),W,e(" selects data points at equal index intervals. "),H,e(" assigns data points to the buckets based on the number of sampling. Then it calculates the area of the triangle based on these points inside the bucket and selects the point with the largest area of the triangle. For more detail, please read "),s("a",R,[e("paper"),a(r)])]),V])}const j=d(p,[["render",G],["__file","Data-Profiling.html.vue"]]);export{j as default};