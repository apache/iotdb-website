...
`),m,e("p",null,[i("The specified syntax for compression is detailed in "),r(t,{to:"/UserGuide/V1.2.x/Reference/SQL-Reference.html"},{default:c(()=>[i("Create Timeseries Statement")]),_:1}),i(".")]),p,u,f,_])}const N=s(h,[["render",g],["__file","Compression.html.vue"]]);export{N as default};
