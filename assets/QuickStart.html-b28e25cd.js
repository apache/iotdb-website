...
or
IoTDB&gt; exit
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,36),D=n(`<h3 id="stop-iotdb" tabindex="-1"><a class="header-anchor" href="#stop-iotdb" aria-hidden="true">#</a> Stop IoTDB</h3><p>The server can be stopped with ctrl-C or the following script:</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code># Unix/OS X
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div>`,8),y={href:"https://iotdb.apache.org/UserGuide/V1.0.x/Administration-Management/Administration.html",target:"_blank",rel:"noopener noreferrer"},B=n('<h2 id="basic-configuration" tabindex="-1"><a class="header-anchor" href="#basic-configuration" aria-hidden="true">#</a> Basic configuration</h2><p>The configuration files is in the <code>conf</code> folder, includes:</p><ul><li>environment configuration (<code>datanode-env.bat</code>, <code>datanode-env.sh</code>),</li><li>system configuration (<code>iotdb-datanode.properties</code>)</li><li>log configuration (<code>logback.xml</code>).</li></ul>',3);function A(N,R){const a=d("RouterLink"),s=d("ExternalLinkIcon");return l(),c("div",null,[u(`
...
`),m,e("p",null,[i("This short guide will walk you through the basic process of using IoTDB. For a more-complete guide, please visit our website's "),t(a,{to:"/UserGuide/Master/IoTDB-Introduction/What-is-IoTDB.html"},{default:o(()=>[i("User Guide")]),_:1}),i(".")]),v,b,p,g,f,e("ul",null,[_,T,e("li",null,[i("Using Docker：The path to the dockerfile is "),e("a",x,[i("github"),t(s)])])]),w,e("p",null,[i("You can download the binary file from: "),e("a",I,[i("Download Page"),t(s)])]),S,e("p",null,[i("For more, see "),t(a,{to:"/UserGuide/Master/Reference/DataNode-Config-Manual.html"},{default:o(()=>[i("Config")]),_:1}),i(" in detail.")]),E,e("p",null,[i("For more on what commands are supported by IoTDB SQL, see "),t(a,{to:"/UserGuide/Master/Reference/SQL-Reference.html"},{default:o(()=>[i("SQL Reference")]),_:1}),i(".")]),D,e("p",null,[i("More about administration management："),e("a",y,[i("Administration Management"),t(s)])]),B])}const L=r(h,[["render",A],["__file","QuickStart.html.vue"]]);export{L as default};