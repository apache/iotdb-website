...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><ol start="2"><li>启动同步功能发送端</li></ol><p>用户可以使用<code>$IOTDB_HOME/tools</code>文件夹下的脚本启动同步功能的发送端 Linux 系统与 MacOS 系统启动命令如下：</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>  Shell &gt;$IOTDB_HOME/tools/start-sync-client.sh
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><h5 id="关闭同步功能发送端" tabindex="-1"><a class="header-anchor" href="#关闭同步功能发送端" aria-hidden="true">#</a> 关闭同步功能发送端</h5><p>用户可以使用<code>$IOTDB_HOME/tools</code>文件夹下的脚本关闭同步功能的发送端。 Linux 系统与 MacOS 系统停止命令如下：</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>  Shell &gt;$IOTDB_HOME/tools/stop-sync-client.sh
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div>`,35);function p(m,g){const d=a("ExternalLinkIcon");return s(),o("div",null,[l(`
...
`),h,e("p",null,[t("当出现异常场景时，即两个或两个以上的发送端向同一个接收端同步相同设备（其存储组设为 "),e("a",u,[t("root.sg"),r(d)]),t(") 的数据时，后被接收端收到的含有该设备数据的发送端的 "),e("a",b,[t("root.sg"),r(d)]),t(" 数据将会被拒绝接收。示例：发送端 1 向接收端同步存储组 root.sg1 和 root.sg2, 发送端 2 向接收端同步存储组 root.sg2 和 root.sg3, 均包括时间序列 root.sg2.d0.s0, 若接收端先接收到发送端 1 的 root.sg2.d0.s0 的数据，那么接收端将拒绝发送端 2 的 root.sg2 同步的数据。")]),v])}const y=i(c,[["render",p],["__file","Sync-Tool.html.vue"]]);export{y as default};